...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0043_Vol03'"/>
    ...
    <xsl:param name="volumeNumber" as="xs:integer" select="3"/> <!-- number of the volume in a multi-volume work (must be "0" for single-volume works)  -->
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2024-10-23'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI-Tite to TEI-All.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0043_Vol03_change_009'"/>
    ...
    <xsl:include href="W0043_Vol03_003b.xsl"/>
  ...
  <teiHeader>
        ...
        <revisionDesc status="a_raw">
            <listChange ordered="true">
                ...
                <change who="#CR #auto" when="2022-09-22" status="a_raw" xml:lang="en" xml:id="W0043_Vol03_change_008">Added (la) abbreviations depending on word structure with regex.</change>
