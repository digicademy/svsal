...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0030_change_005'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Changed pb, cb attributes dependending on lb break=nos'"/>
