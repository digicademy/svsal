...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0063_Vol10'"/>
    <xsl:param name="textId" as="xs:string" select="'Vol10'"/> <!-- "completeWork" (for the whole work) or "Vol_xx" (for volume xx) -->
    ...
    <xsl:param name="volumeNumber" as="xs:integer" select="10"/> <!-- number of the volume in a multi-volume work (must be "0" for single-volume works)  -->
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2024-04-24'"/>
    ...
    <xsl:include href="W0063_Vol10_001b.xsl"/>
...
<xsl:variable name="teiHeaderCopy" xml:space="preserve">
  <teiHeader>
        <fileDesc>
            <titleStmt>
                <title type="short" level="m">Omnes fere tituli tam iuris civilis</title>
                <title type="main" level="m">Omnes fere tituli tam iuris civilis, quam canonici leguntur in istis septem partitarum legibus, quod sequens tabula demonstrat</title>
                <author>
            ...
            <editionStmt>
                <edition n="1.0.0" xml:id="W0063_Vol10-version1" xml:lang="en">
            ...
            <publicationStmt xml:id="publicationStmt">
                ...
                <idno>
                    <idno xml:id="urlid">https://id.salamanca.school/texts/W0063:vol10</idno>
                    <idno xml:id="urltei">https://id.salamanca.school/texts/W0063:vol10?format=tei</idno>
                    <idno xml:id="urlhtml">https://id.salamanca.school/texts/W0063:vol10?format=html</idno>
                    <idno xml:id="urlrdf">https://id.salamanca.school/texts/W0063:vol10?format=rdf</idno>
                    <idno xml:id="urliiif">https://id.salamanca.school/texts/W0063:vol10?format=iiif</idno>
                    <idno xml:id="urltxtorig">https://id.salamanca.school/texts/W0063:vol10?format=txt&amp;mode=orig</idno>
                </idno>
            </publicationStmt>
            ...
            <seriesStmt>
                ...
                <biblScope unit="volume" n="32.10">Volume 32.10</biblScope>
            </seriesStmt>
            <notesStmt>
            ...
            <sourceDesc>
                <biblStruct>
                    <monogr>
                        ...
                        <extent xml:lang="de">15 ungezählte Seiten</extent>
                        <extent xml:lang="en">15 p.</extent>
                        <extent xml:lang="es">15 p.</extent>
                    </monogr>
                </biblStruct>
                <msDesc>
                    <msIdentifier>
                        <repository ref="gnd:1231401982" xml:lang="de">Max-Planck-Institut für Rechtsgeschichte und Rechtstheorie.</repository>
                        <idno type="catlink" xml:lang="de">https://sunrise.lhlt.mpg.de/webOPACClient/start.do?KatKeySearch=646656</idno>
                    </msIdentifier>
                    <physDesc>
                        <typeDesc>
        ...
        <encodingDesc>
            ...
            <editorialDecl>
                ...
                <p xml:id="W0063_Vol10_RW">Reference works contain automatic hyphenation of marked and unmarked words in the pb, cb and lb elements.
        ...
        <revisionDesc status="g_enriched_approved">
            <listChange ordered="true">
                <change who="#CR #auto" when="2024-04-24" status="a_raw" xml:id="W0063_Vol10_change_005" xml:lang="en"><xsl:value-of select="$editingDesc"/></change>
                <change who="#CR #auto" when="2024-04-24" status="g_enriched_approved" xml:id="W0063_Vol10_change_004" xml:lang="en">teiHeader update for publication.</change>
                <change who="#CR" when="2024-04-24" status="a_raw" xml:id="W0063_Vol10_change_003" xml:lang="en">Structural annotation.</change>
                <change who="#CR" when="2023-11-23" status="a_raw" xml:id="W0063_Vol10_change_002" xml:lang="en">teiHeader: Author correction.</change>
                <change who="#CR" when="2022-03-03" status="a_raw" xml:id="W0063_Vol10_change_001" xml:lang="en">Set teiHeader.</change>
            </listChange>
        </revisionDesc>
    </teiHeader>
</xsl:variable>
