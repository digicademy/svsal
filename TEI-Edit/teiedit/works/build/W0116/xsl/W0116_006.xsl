...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0116_change_007'"/>
  ...
  <xsl:message terminate="no" select="concat('Pb: ', ./tei:pb/@xml:id)"/>
  <xsl:message terminate="no" select="concat('correspSameAs: ',./tei:pb/@sameAs)"/>
                            <xsl:element name="margElem" namespace="">
