...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0001_Vol02'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0001_Vol02_change_012'"/>
    ...
    <xsl:include href="W0001_Vol02_004b.xsl"/>
    ...
    <teiHeader>
        ...
        <revisionDesc status="a_raw">
            <listChange>
                ...
                <!--<change who="#CR" when="yyyy-mm-dd" status="a_raw" xml:lang="en" xml:id="W0001_Vol02_change_xxx">Added ref in table of contents.</change>-->
