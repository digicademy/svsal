...
<!--Content and Index in nested lists-->
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0001_Vol02_change_XXX'"></xsl:param>
    <xsl:param name="editingDesc" as="xs:string" select="'Content and Index in nested lists'"/>
    ...
    <xsl:template match="tei:list[@type=('contents','index')]//tei:item[not(descendant::tei:list)]">
        <xsl:copy>
            <xsl:choose>
                ...
                <xsl:when test="ancestor::tei:list[@type='contents']">
                    <xsl:element name="list">
    ...
    <xsl:template match="tei:list[@type=('contents','index')]//tei:item//tei:p[1][not(ancestor::tei:argument)]">
    ...
    <xsl:template match="tei:list[@type=('contents','index')]//tei:item//tei:p[preceding-sibling::tei:p]"> 
