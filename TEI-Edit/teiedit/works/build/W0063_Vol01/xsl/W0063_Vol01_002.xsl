...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0063_Vol01'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0063_Vol01_change_006'"/>
    ...
    <xsl:include href="W0063_Vol01_002b.xsl"/>
  ...
  <teiHeader>
        ...
        <revisionDesc status="a_raw">
            <listChange ordered="true">
                <change who="#CR #auto" when="2024-01-17" status="a_raw" xml:lang="en"  xml:id="{$changeId}"><xsl:value-of select="$editingDesc"/></change>
