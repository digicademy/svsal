...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0039_change_018'"></xsl:param>
    <xsl:param name="editingDesc" as="xs:string" select="'Added @xml:id and @unit to milestone.'"/>
