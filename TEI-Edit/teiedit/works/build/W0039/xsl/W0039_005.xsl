...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0039'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2020-04-29'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI-tite to TEI-All.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0039_change_019'"/>
    ...
    <!-- templates for processing elements within tei:text are included from WXXXX_XXX-b.xsl -->
    <xsl:include href="W0039_005b.xsl"/>
    ...
    <xsl:variable name="teiHeaderCopy" xml:space="preserve">
        ...
        <fileDesc>
            <titleStmt>
                ...
                <author>
                    <persName ref="author:A0024 cerl:cnp00086868 gnd:119253593">
                ...
                <biblStruct>
                    <monogr>
                        ...
                        <imprint>
                            ...
                            <publisher n="firstEd">
                                <persName ref="cerl:cni00034721" key="Gabiano, Scipion de"> <!--not in GND-->
        ...
        <revisionDesc status="a_raw">
            <listChange ordered="true">
                <change who="{$editors}" xml:id="{$changeId}" when="{$editingDate}" status="a_raw" xml:lang="en"><xsl:value-of select="$editingDesc"/></change>
