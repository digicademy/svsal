...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2025-05-06'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0067_change_003'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Tagged @n, @type in div(s), list(s).'"/>
