...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0067'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:include href="W0067_003b.xsl"/>
  ...
  <teiHeader>
            ...
            <sourceDesc>
                <biblStruct>
                    <monogr>
                        ...
                        <extent xml:lang="de">[8], 446, [10] S. ; 4º</extent>
        ...
        <revisionDesc status="a_raw">
            <listChange ordered="true">
                <change who="#CR #auto" when="2025-05-13" status="a_raw" xml:lang="en" xml:id="W0067_change_006"><xsl:value-of select="$editingDesc"/></change>
