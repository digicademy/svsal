...
text = open("D:/Cindy/SVN/trunk/teiedit/works/build/W0067/xml/W0067_010.xml", encoding='utf-8').read()
...
cases = {
    ...
    '<listChange ordered="true">\n                ' : '<listChange ordered="true">\n                <change who="#CR #auto" when="2025-05-15" status="a_raw" xml:id="W0067_change_013" xml:lang="en">Automatically expanded abbreviations with lb/@break using python.</change>\n                '
}
...
W0067_011 =open('D:/Cindy/SVN/trunk/teiedit/works/build/W0067/xml/W0067_011.xml', 'w', encoding='utf-8')
W0067_011.write(text_output)
W0067_011.close()
