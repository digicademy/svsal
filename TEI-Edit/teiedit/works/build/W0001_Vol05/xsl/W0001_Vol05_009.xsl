...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2019-08-05'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0001_change_009'"></xsl:param>
    <xsl:param name="editingDesc" as="xs:string" select="'Added foreign to quote with @xml:lang'"/>
    ...
    <xsl:template match="@*|node()">
     ...
     <xsl:template match="tei:quote[@xml:lang eq 'es']">
         <xsl:copy>
             <xsl:copy-of select="@*"/>
