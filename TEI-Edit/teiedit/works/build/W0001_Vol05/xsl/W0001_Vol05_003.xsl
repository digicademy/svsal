...
<!--Content and Index in nested lists-->
    ...
    <xsl:template match="tei:list[@type='index']//tei:item[not(descendant::tei:list)]">
        <xsl:copy>
            <xsl:choose>
    ...
    <xsl:template match="tei:list[@type='index']//tei:item//tei:p[1][not(ancestor::tei:argument)]">
    ...
    <xsl:template match="tei:list[@type= 'index']//tei:item//tei:p[preceding-sibling::tei:p]"> 
