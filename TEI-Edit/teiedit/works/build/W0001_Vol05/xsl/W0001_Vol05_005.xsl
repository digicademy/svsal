...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0001_Vol05'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2019-07-30'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI Tite to TEI P5.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0001_Vol05_change-005'"/>
    ...
    <xsl:include href="W0001_Vol05_005b.xsl"/>
    ...
    <teiHeader>
        <fileDesc>
            ...
            <titleStmt>
                ...
                <title type="main" level="m">R. P. Didaci De Avendaño Societatis Iesv, Segoviensis, In S. Inquisitionis Tribunali electo Censore. 
                    Avctarii Indici Tomvs Tertivs, Sev Thesavri Tomvs Qvintvs, Multa continens peculiaria, &amp; generatim vtilia</title>
            ...
            <sourceDesc>
                <biblStruct>
                    <monogr>
                        ...
                        <extent xml:lang="de">[12], 441, [22] S. ; 2°</extent>
            ...
            <listChange>
                ...
                <change who="#IC" when="2014-11-13" status="a_raw">
                    <list>
                        ...
                        <item xml:id="item_asasaslj">Regel in Editionsrichtlinien aufgenommen: Wenn wir eine andere  Ausgabe digitalisieren müssen, werden züsätzlich zu den Angaben der ersten Ausgabe, Angaben zur vorliegenden Ausgabe gemacht: pubPlace@role=thisEd, date@type=thisEd, publisher@type=
