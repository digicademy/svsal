...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2020-06-04'"/>
    <xsl:param name="changeId" as="xs:string"/>
    <xsl:param name="editingDesc" as="xs:string" select="concat('Automatically expanded abbreviations (', $lang, '-',$mode,') upadate.')"/>
