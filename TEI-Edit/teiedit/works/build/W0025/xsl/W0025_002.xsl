...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2026-04-07'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0025_change_003'"/>
...
<!-- 1) Final ũ|ū - um, legũ, appellatũ"-->
    ...
    <xsl:variable name="final-um">
        <xsl:apply-templates select="$Spiritum" mode="final-um"/>
    </xsl:variable>
