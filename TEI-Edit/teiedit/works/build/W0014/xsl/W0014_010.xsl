...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2018-07-11'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0014_change_019'"></xsl:param>
    <xsl:param name="editingDesc" as="xs:string" select="'Tag unmarked hyphenations.'"/>
    ...
    <xsl:variable name="hyphenatingLbIds" as="xs:string*" select="doc('../html/W0014_comp-hyph.html')//tr/td[7]/a/@id/string()"/>
