...
<!--
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0012_change_011'"></xsl:param>
    <xsl:param name="editingDesc" as="xs:string" select="'Changed hi @rend right to seg @type gap'"/>
    ...
    <xsl:template match="tei:list[@type='index']//tei:hi[@rend eq 'right']">
        <xsl:element name="seg">
        <xsl:attribute name="type" select="'gap'"/>
