...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0012_change_010'"></xsl:param>
    <xsl:param name="editingDesc" as="xs:string" select="'Tagged entries with label.'"/>
    ...
    <xsl:template match="tei:body//t:smcap[ancestor::tei:div3[@type eq 'entry'] and not(preceding-sibling::t:smcap)]">
