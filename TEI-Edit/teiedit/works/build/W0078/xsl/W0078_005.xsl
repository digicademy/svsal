...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0078'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0078-change-012'"/>
    ...
    <xsl:include href="W0078_005b.xsl"/>
    ...
    <teiHeader>
        <fileDesc>
            ...
            <titleStmt>
                ...
                <title level="m" type="main">Lexicon Iuris Civilis, Adversvs quosdam insignes Accvrs errores æditum Antonio Nebrissensi Uiro undecunque doctißimo autore</title>
                <author>
                ...
                <biblStruct>
                    <monogr>
                        ...
                        <imprint>
                            ...
                            <publisher n="firstEd">
                                <persName ref="cerl:cni00030497" key="Frellon, Jean"> <!--not in GND-->
                                    <forename>Ioannes</forename>
                                    <surname>Frellaeus</surname>
                                </persName>
                                <persName ref="cerl:cni00028532" key="Frellon, François"> <!--not in GND-->
                                    <forename>Franciscus</forename>
                                    <surname>Frellaeus</surname>
                                </persName>
                                <persName ref="cerl:cni00033028" key="Barbou, Jean"> <!--not in GND-->
                                    <forename>Jean</forename>
                                    <surname> Barbous</surname>
                                </persName>
                            </publisher>
                        </imprint>
                        <extent xml:lang="de">210 S., [6] Bl. ; 8°</extent>
                        <extent xml:lang="en">210 p., [6] l. ; 8°</extent>
                        <extent xml:lang="es">210 p., [6] h. ; 8°</extent>
                    </monogr>
                </biblStruct>
                <msDesc>
                    <msIdentifier>
