...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2025-02-04'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0065_change_013'"/>
    <xsl:param name="editingDesc" as="xs:string" select="concat('Tag unmarked breaks in marginals (', $lang, ').')"/>
