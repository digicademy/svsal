...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0063_Vol11'"/>
    <xsl:param name="textId" as="xs:string" select="'Vol11'"/> <!-- "completeWork" (for the whole work) or "Vol_xx" (for volume xx) -->
    ...
    <xsl:param name="volumeNumber" as="xs:integer" select="11"/> <!-- number of the volume in a multi-volume work (must be "0" for single-volume works)  -->
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:include href="W0063_Vol11_001b.xsl"/>
...
<xsl:variable name="teiHeaderCopy" xml:space="preserve">
  <teiHeader>
        <fileDesc>
            ...
            <editionStmt>
                <edition n="1.0.0" xml:id="W0063_Vol11-version1" xml:lang="en">
                    Complete digitized edition, <date type="digitizedEd" when="2024-05-15">2024-05-15</date>.
                </edition>
            </editionStmt>
            ...
            <publicationStmt xml:id="publicationStmt">
                ...
                <date type="digitizedEd" when="2024-05-15">2024-05-15</date>
                <idno>
                    <idno xml:id="urlid">https://id.salamanca.school/texts/W0063:vol11</idno>
                    <idno xml:id="urltei">https://id.salamanca.school/texts/W0063:vol11?format=tei</idno>
                    <idno xml:id="urlhtml">https://id.salamanca.school/texts/W0063:vol11?format=html</idno>
                    <idno xml:id="urlrdf">https://id.salamanca.school/texts/W0063:vol11?format=rdf</idno>
                    <idno xml:id="urliiif">https://id.salamanca.school/texts/W0063:vol11?format=iiif</idno>
                    <idno xml:id="urltxtorig">https://id.salamanca.school/texts/W0063:vol11?format=txt&amp;mode=orig</idno>
                </idno>
            </publicationStmt>
            ...
            <seriesStmt>
                ...
                <biblScope unit="volume" n="32.11">Volume 32.11</biblScope>
            </seriesStmt>
            <notesStmt>
            ...
            <sourceDesc>
                <biblStruct>
                    <monogr>
                        ...
                        <extent xml:lang="de">462 ungezählte Seiten</extent>
                        <extent xml:lang="en">[462] p.</extent>
                        <extent xml:lang="es">[462] p.</extent>
                    </monogr>
                </biblStruct>
                <msDesc>
                    <msIdentifier>
                        <repository ref="gnd:1231401982" xml:lang="de">Max-Planck-Institut für Rechtsgeschichte und Rechtstheorie.</repository>
                        <idno type="catlink" xml:lang="de">https://sunrise.lhlt.mpg.de/webOPACClient/start.do?KatKeySearch=646657</idno>
                    </msIdentifier>
                    <physDesc>
                        <typeDesc>
        ...
        <encodingDesc>
            ...
            <editorialDecl>
                ...
                <p xml:id="W0063_Vol11_RW">Reference works contain automatic hyphenation of marked and unmarked words in the pb, cb and lb elements.
        ...
        <revisionDesc status="g_enriched_approved">
            <listChange ordered="true">
                <change who="#CR #auto" when="2024-05-08" status="a_raw" xml:id="W0063_Vol11_change_005" xml:lang="en"><xsl:value-of select="$editingDesc"/></change>
                <change who="#CR #auto" when="2024-05-08" status="g_enriched_approved" xml:id="W0063_Vol11_change_004" xml:lang="en">teiHeader update for publication.</change>
                <change who="#CR" when="2024-05-08" status="a_raw" xml:id="W0063_Vol11_change_003" xml:lang="en">Structural annotation and unclear marks resolution.</change>
                <change who="#CR" when="2023-11-23" status="a_raw" xml:lang="en">teiHeader: Author correction.</change>
