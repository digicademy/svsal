...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0037_Vol01_change_005'"></xsl:param>
    ...
    <xsl:template match="tei:list[@type='summaries']//tei:ref">
        <xsl:copy>
            ...
            <!--<xsl:message>Summaries, adding @target to ref using @xml:id in milestone</xsl:message>-->
                ...
                <xsl:variable name="milestoneId" select="following::tei:milestone[ancestor::tei:div2 = current()/ancestor::tei:div2][@n eq $refNumber][1]/@xml:id"/>
                <xsl:choose>
