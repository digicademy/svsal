...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0008_Vol04_change_011'"></xsl:param>
    <xsl:param name="editingDesc" as="xs:string" select="'Added xml:ids to milestones and cross references in summaries'"/>
    ...
    <!--Deleted @type='noCB' from cb-->
    <xsl:template match="tei:cb[@type='noCB']">
        <xsl:copy>
