...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0056'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editors" as="xs:string" select="'#PS #DG #CR #auto'"/>
    <xsl:param name="editingDate" as="xs:string" select="'2026-08-06'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI-Tite to TEI-All.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0056-change-008'"/>
    ...
    <xsl:include href="W0056_004b.xsl"/>
