...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editors" as="xs:string" select="'#PS #CR #auto'"/>
    <xsl:param name="editingDate" as="xs:string" select="'2025-08-06'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0056_change_006'"></xsl:param>
...
<!-- Exception W0035 Words ending with (ũ|ũ|ū|ū - un). e.g. segũ, algũ-->
    ...
    <xsl:variable name="final-un">
        <xsl:apply-templates select="$final-en" mode="final-un"/>
    </xsl:variable>
...
<!-- 14) ũ + ar e.g. pregũtar, renũciar-->
    ...
    <xsl:variable name="unar">
        <xsl:apply-templates select="$final-an" mode="unar"/>
    </xsl:variable>
...
<!--lb rendition hyphen-->
    <xsl:variable name="Put-LBHyphen-back">
        <xsl:apply-templates select="$only-y" mode="Put-LBHyphen-back"/>
    </xsl:variable>
