...
text = open("D:/Polina/SVN/trunk/teiedit/works/build/W0056/xml/W0056_013.xml", encoding='utf-8').read()
...
cases = {
    ...
    '<listChange ordered="true">\n                ' : '<listChange ordered="true">\n                <change who="#CR #PS #auto" when="2025-09-04" status="a_raw" xml:id="W0056_change_017" xml:lang="en">Automatically expanded abbreviations with lb/@break using python.</change>\n                '
}
...
W0056_014 =open('D:/Polina/SVN/trunk/teiedit/works/build/W0056/xml/W0056_014.xml', 'w', encoding='utf-8')
W0056_014.write(text_output)
W0056_014.close()
