...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2026-02-18'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0091_change_005'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Adding @target to ref in summaries.'"/>
    ...
    <xsl:template match="tei:div1[@type eq 'preface']//tei:list[@type='summaries']//tei:ref[not(@target)]">
        <xsl:copy>
            <xsl:copy-of select="@*"/>
    ...
    <xsl:template match="tei:div1[@type eq 'book']//tei:list[@type='summaries']//tei:ref[not(@target)]">
        <xsl:copy>
            <xsl:copy-of select="@*"/>
            <!--<xsl:message>Adding @target to ref in summaries.</xsl:message>-->
                <xsl:variable name="refNumber" as="xs:string" select="."/>
