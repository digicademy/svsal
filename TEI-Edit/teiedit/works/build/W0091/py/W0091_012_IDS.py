...
text = open("D:/Cindy/SVN/trunk/teiedit/works/build/W0091/xml/W0091_012.xml", encoding='utf-8').read()
...
cases = {
    ...
    '<listChange ordered="true">\n                ' : '<listChange ordered="true">\n                <change who="#CR #auto" when="2026-03-03" status="a_raw" xml:id="W0091_change_016" xml:lang="en">Automatically expanded abbreviations with lb/@break using python.</change>\n                '
}
...
# --- NEW: add xml:ids to //expan[@resp contains '#CRPY' and '#auto']//lb[@sameAs] using lxml ---
...
W0091_013 =open('C:/Users/cricocar/Downloads/W0091_013.xml', 'w', encoding='utf-8')
W0091_013.write(text_output)
W0091_013.close()
