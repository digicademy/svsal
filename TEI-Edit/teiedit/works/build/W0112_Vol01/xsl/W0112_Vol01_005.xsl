...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2025-05-13'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0112_change_008'"/>
...
| How to add new cases:  |
 ########################     
     ...
     5) Write a template that matches only text in latin, which is not tagged as expansion yet and add the new mode:
          ...
          <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="ExampleNew">
...
<!-- 1) Final ũ|ū - um, legũ, appellatũ"-->
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="final-um">
...
<!-- 2) Final ā|ã - am, primā, verā"-->
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="Alexan">
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="Alexand">
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="Ioan">
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="Fran">
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="final-am">
...
<!--3)  ā + final di|dum|t|ti|tibus|tis|tur, an, mode="antur"-->
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="antur">
...
<!--4)  Beginning pro (chara753), ꝓbari probari, mode="pro1"-->
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="pro1">
...
<!--5) Final - us (chara770), legitimꝰ - legitimus, mode="final-us"-->     
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="final-us">
...
<!-- 6)  õ + c|d|f|s|t ==> on cōsensu consensu, mode="on-cdfst"-->
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="on-cdfst">
 ...
 <xsl:variable name="exception-commune">
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="exception-commune">
...
<!-- 7) õ + final e|es, petitiōe petitione, mode="ones" with ratione exception (MAH)-->
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="ones">
...
<!--exception ũ + t|tur = aũt => autem-->
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="exception-autem">
...
<!--exception ũ + t|tur = aũt => autem mode="exception-autem2"-->
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="exception-autem2">
...
<!-- 8) ũ + t|tur, deducũtur deducuntur, mode="untur" -->  
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="untur">
...
<!-- 9) ẽ + da|dam|di|dis|dus|sis|t|te|tia|tiam|tias|tur, mode="entur"
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="entur">
...
<!-- 10) ẽ + b|m|p, exẽplo exemplo, mode="em-pmb" -->
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="em-pmb">
...
<!-- 11) ĩ  ==> in, only white spaces boundaries, mode="in" -->
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="in">
...
<!-- 12) đ ==> de, only white spaces boundaries, mode="de" -->
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="de">
...
<!-- 13) q + ´ + ; ==> que, leuisq́;, mode="qac"-->
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="qac">
...
<!-- 14) q3 + ´ (chare8bf0301) Exemplum́  mode="q3accent"-->
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="q3accent">
...
<!-- 15) q3 (chare8bf), mode="q3"-->
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="q3">
...
<!--16) ⁊ (char204a) ==> et. , mode="only-et"-->
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="only-et">
...
<!--17) final t with tilde - deprauet̃, = deprauetur, teneat̃ = teneatur mode="final-t-tilde"-->
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="final-t-tilde">
...
<!-- 18: noster--> 
  ...
  <xsl:variable name="noster">
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="noster">
...
<!-- 19) new variant of q; -->
 ...
 <xsl:variable name="qz">
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="qz">
...
<!-- 20) sanctus exception, MAH-->
 ...
 <xsl:template match="@*|node()" mode="sct">
    ...
    <xsl:template match="tei:foreign//text()[not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('es','grc','gr','he','fr','pt','it')])]" mode="sct">
