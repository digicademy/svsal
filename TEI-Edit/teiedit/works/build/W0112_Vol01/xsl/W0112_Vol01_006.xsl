...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0112_Vol01'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2025-06-03'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI-Tite to TEI-All.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0112_Vol01_change_009'"/>
    ...
    <xsl:include href="W0112_Vol01_006b.xsl"/>
    ...
    <teiHeader>
        ...
        <revisionDesc status="a_raw">
            <listChange ordered="true">
                ...
                <change who="#CR #auto" when="2025-05-13" status="a_raw" xml:lang="en" xml:id="W0112_Vol01_change_008">Added (la) abbreviations depending on word structure with regex.</change>
                <change who="#CR #auto" when="2025-05-13" status="a_raw" xml:lang="en" xml:id="W0112_Vol01_change_007">Added (es) abbreviations depending on word structure with regex.</change>
