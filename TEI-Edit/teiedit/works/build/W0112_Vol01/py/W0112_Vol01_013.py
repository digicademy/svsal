...
text = open("D:/SVN/trunk/teiedit/works/build/W0112_Vol01/xml/W0112_Vol01_013.xml", encoding='utf-8').read()
...
cases = {
    ...
    '<listChange ordered="true">\n                ' : '<listChange ordered="true">\n                <change who="#CR #auto" when="2025-06-05" status="a_raw" xml:id="W0112_Vol01_change_018" xml:lang="en">Automatically expanded abbreviations with lb/@break using python.</change>\n                '
}
...
W0112_Vol01_014 =open('D:/SVN/trunk/teiedit/works/build/W0112_Vol01/xml/W0112_Vol01_014.xml', 'w', encoding='utf-8')
W0112_Vol01_014.write(text_output)
W0112_Vol01_014.close()
