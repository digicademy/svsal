...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2025-03-25'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0035_change_003'"/>
...
-->
    ...
    <xsl:variable name="Put-LBHyphen-back">
        <xsl:apply-templates select="$qz" mode="Put-LBHyphen-back"/>
    </xsl:variable>
    ...
    <xsl:template match="tei:abbr[@rend eq 'expan']/tei:lb" mode="sameAs">
        <xsl:variable name="abbr-ID" select="preceding::tei:abbr[@rend eq 'abbr']/tei:lb[ancestor::tei:abbr[@rend eq 'choice'] = current()/ancestor::tei:abbr[@rend eq 'choice']][1]/@xml:id"/>
        <xsl:copy>        
            <xsl:copy-of select="@*"/>
