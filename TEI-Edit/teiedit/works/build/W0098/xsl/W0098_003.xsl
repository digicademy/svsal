...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0098'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editors" as="xs:string" select="'#DG #CR #MAH #auto'"/>
    <xsl:param name="editingDate" as="xs:string" select="'2025-07-10'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI-Tite to TEI-All.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0098_change_005'"/>
    ...
    <xsl:include href="W0098_003b.xsl"/>
            ...
            <sourceDesc>
                ...
                <msDesc>
                    <msIdentifier>
                        ...
                        <idno type="catlink" xml:lang="en">http://access.bl.uk/item/viewer/ark:/81055/vdc_100026327668.0x000001</idno>
                    </msIdentifier>
                ...
                <msDesc status="a_raw" corresp="#facs:0382 #facs:0383 #facs:0552 #facs:0553 #facs:0618 #facs:0619">
                    <msIdentifier>
                        ...
                        <idno type="catlink" xml:lang="es">http://www.bibliotecavirtualdeandalucia.es/catalogo/es/consulta/registro.cmd?id=8778</idno>
                    </msIdentifier>
