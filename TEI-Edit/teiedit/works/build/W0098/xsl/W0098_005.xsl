...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2025-07-11'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Annotated hyphenated breaks.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0098_change_007'"/>
...
<xsl:message terminate="no" select="concat('hyphenatingPb :', $hyphenatingPb)"/>
<xsl:message terminate="no" select="concat('hyphenatingCb :', $hyphenatingCb)"/>
<xsl:message terminate="no" select="concat('$breakingLb :', $breakingLb)"/>
            </xsl:when>
