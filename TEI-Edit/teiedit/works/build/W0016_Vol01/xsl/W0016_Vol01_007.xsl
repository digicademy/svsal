...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editors" as="xs:string" select="'#DG #MA #auto'"/>
    <xsl:param name="editingDate" as="xs:string" select="'2025-01-17'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0016_Vol01_change_007'"/>
...
<!--    
    ...
    </xsl:template> Commented because two pb are incorrectly tagged as no and hyphen-->
