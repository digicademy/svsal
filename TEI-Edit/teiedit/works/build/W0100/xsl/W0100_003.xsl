...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0100'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2026-05-07'"/>
    ...
    <xsl:include href="W0100_003b.xsl"/>
  ...
  <teiHeader>
        ...
        <revisionDesc status="a_raw">
            <listChange ordered="true">
                ...
                <change who="#CR #MAH #auto" when="2026-05-28" status="a_raw" xml:lang="en" xml:id="W0100_change_005">Added (la) abbreviations depending on word structure with regex.</change>
