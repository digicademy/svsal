...
text = open("D:/Cindy/SVN/trunk/teiedit/works/build/W0100/xml/W0100_011.xml", encoding='utf-8').read()
...
cases = {
    ...
    '<listChange ordered="true">\n                ' : '<listChange ordered="true">\n                <change who="#CR #auto" when="2026-06-02" status="a_raw" xml:id="W0100_change_014" xml:lang="en">Automatically expanded abbreviations with lb/@break using python.</change>\n                '
}
...
W0XXX_XXX =open('D:/Cindy/SVN/trunk/teiedit/works/build/W0100/xml/W0100_012.xml', 'w', encoding='utf-8')
