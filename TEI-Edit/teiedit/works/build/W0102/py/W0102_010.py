...
text = open("D:/Cindy/SVN/trunk/teiedit/works/build/W0102/xml/W0102_010.xml", encoding='utf-8').read()
...
cases = {
    ...
    '<listChange ordered="true">\n                ' : '<listChange ordered="true">\n                <change who="#CR #auto" when="2025-12-17" status="a_raw" xml:id="W0102_change_013" xml:lang="en">Automatically expanded abbreviations with lb/@break using python.</change>\n                '
}
...
W0102 =open('D:/Cindy/SVN/trunk/teiedit/works/build/W0102/xml/W0102_011.xml', 'w', encoding='utf-8')
W0102.write(text_output)
W0102.close()
