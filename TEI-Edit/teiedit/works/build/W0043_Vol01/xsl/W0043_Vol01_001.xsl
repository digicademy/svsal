...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0043_Vol01_change_007'"></xsl:param>
    <xsl:param name="editingDesc" as="xs:string" select="'Corrected pagination in front.'"/>
