...
<!-- namespaces
    ...
    <xsl:param name="workId" as="xs:string" select="'W0043_Vol01'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2021-10-18'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI-Tite to TEI-All.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0043_Vol01_change_011'"/>
    ...
    <xsl:include href="W0043_Vol01_005b.xsl"/>
...
<xsl:variable name="teiHeaderCopy" xml:space="preserve" exclude-result-prefixes="tei">
  <teiHeader>
        <fileDesc>
            <titleStmt>
                ...
                <author>
                    <persName ref="author:A0029 gnd:121064751 cerl:cnp01036518" key="Escobar y Mendoza, Antonio de"> <!-- z.B. author:A0019 (Autor-ID im Salamanca-Corpus) -->
            ...
            <sourceDesc>
                <biblStruct>
                    <monogr>
                        ...
                        <extent xml:lang="de">[16] Bl., 480 S., [10] Bl.</extent>
                        <extent xml:lang="en">[16] Bl., 480 S., [10] l.</extent>
                        <extent xml:lang="es">[16] Bl., 480 S., [10] h.</extent>
                    </monogr>
                </biblStruct>
                <msDesc>
                    <msIdentifier>
