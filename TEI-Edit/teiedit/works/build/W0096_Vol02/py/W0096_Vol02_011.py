...
Adapted for W0096_Vol02 from W0043_Vol02
...
For this scenario, the following files were used:
...
text = open("D:/Cindy/SVN/trunk/teiedit/works/build/W0096_Vol02/xml/W0096_Vol02_011.xml", encoding='utf-8').read()
...
# W0096_Vol02 has plenty of spanish passages. Since here the text nodes annotated as foreign are not filtered,
# there are some false positives expansions in spanish related to final ã a with tilde.
# Thus, they are expanded first as literals with the variables "daban, recibirian, tengan",
# then the rest of patterns in latin are run as usually.

daban = 'da<lb rendition="#hyphen" break="no" xml:id="W0096-02-0151-lb-1039"/>b<g ref="#chara0303">ã</g>'

recibirian = 'reci<lb rendition="#hyphen" break="no" xml:id="W0096-02-0548-lb-1057"/>biri<g ref="#chara0303">ã</g>'

tengan = 'ten<lb rendition="#hyphen" break="no" xml:id="W0096-02-0815-lb-1008"/>g<g ref="#chara0303">ã</g>'
...
cases = {
    daban : '<choice><abbr>da<lb rendition="#hyphen" break="no" xml:id="W0096-02-0151-lb-1039"/>b<g ref="#chara0303">ã</g></abbr><expan resp="#CRPY #auto">da<lb rendition="#hyphen" break="no" sameAs="#W0096-02-0151-lb-1039"/>ban</expan></choice>',

    recibirian : '<choice><abbr>reci<lb rendition="#hyphen" break="no" xml:id="W0096-02-0548-lb-1057"/>biri<g ref="#chara0303">ã</g></abbr><expan resp="#CRPY #auto">reci<lb rendition="#hyphen" break="no" sameAs="#W0096-02-0548-lb-1057"/>birian</expan></choice>',

    tengan : '<choice><abbr>ten<lb rendition="#hyphen" break="no" xml:id="W0096-02-0815-lb-1008"/>g<g ref="#chara0303">ã</g></abbr><expan resp="#CRPY #auto">ten<lb rendition="#hyphen" break="no" sameAs="#W0096-02-0815-lb-1008"/>gan</expan></choice>',
    ...
    ones : '\g<1><choice><abbr>\g<2>\g<3>\g<4>\g<5>\g<6>\g<7>\g<8></abbr><expan resp=\"#CRPYones #auto\">\g<2>\g<3>sameAs=\"#\g<5>\g<6>on\g<8></expan></choice>\g<9>',
    ...
    '<listChange ordered="true">\n                ' : '<listChange ordered="true">\n                <change who="#CR #auto" when="2024-08-22" status="a_raw" xml:id="W0096_Vol02_change_017" xml:lang="en">Automatically expanded abbreviations with lb/@break using python.</change>\n                ',

    '(sameAs=\")(#)(W\d+-\d+-\d+-lb-)([\w\d]+)(\")' : '\g<1>\g<2>\g<3>\g<4>\g<5> xml:id=\"\g<3>\g<4>-sa\g<5>'
}
...
W0096_Vol02_012 =open('D:/Cindy/SVN/trunk/teiedit/works/build/W0096_Vol02/xml/W0096_Vol02_012.xml', 'w', encoding='utf-8')
W0096_Vol02_012.write(text_output)
W0096_Vol02_012.close()
