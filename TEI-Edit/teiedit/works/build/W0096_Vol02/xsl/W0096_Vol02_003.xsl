...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0096_Vol02'"/>
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2018-12-11'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from Tite to TEI.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0096_Vol02-00-change-0008'"/>
    ...
    <xsl:include href="W0096_Vol02_003b.xsl"/>
  ...
  <teiHeader>
      ...
      <revisionDesc status="a_raw">
            <listChange ordered="true">
                ...
                <change who="#CB" when="2024-08-08" status="a_raw" xml:id="W0096_Vol02-00-change-0002">Resolved remaining unclear marks.</change>
