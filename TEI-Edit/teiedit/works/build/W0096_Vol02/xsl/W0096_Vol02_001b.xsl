...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2024-08-08'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0096_Vol02-00-change0-0005'"/>
...
<!-- 1) ẽ + "do" e.g. "pudiẽdo"-->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="endo">
...
<!-- 2) ã + "do" e.g. dudãdo -->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="ando">
...
<!-- 3) ẽ + "te|tes" e.g. "mortalmẽte", "gẽte"-->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="ente">
...
<!-- 4) ẽ + "de" e.g. "entiẽde"-->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="ende">
...
<!--5) "õ-on" at the end e.g. "Purificaciõ"-->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="cion">
...
<!-- 6) ẽ + "to" e.g. "mandamiẽto"-->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="ento">
...
<!--7) ẽ + "cia|cias" e.g. "differẽcia"-->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="encia">
...
<!--  8) ã + "ancia" e.g. "ignorãcia"-->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="ancia">
...
<!-- 9) ẽ + "er" e.g. "entẽder"-->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="ener">
...
<!-- 10) ẽ + "ar" e.g. "encomẽdar"-->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="enar">
...
<!-- 11) ã + "ar" e.g. "mãdar"-->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="anar">
...
<!-- 12) Words ending with (ẽ-en). e.g. puedẽ, quiẽ, deuẽ-->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="final-en">
...
<!-- 13) Words ending in (ā-an). e.g. haziā, siruā, podrā-->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="final-an">
...
<!-- 14) ũ + ar e.g. pregũtar, renũciar-->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="unar">
...
<!-- 15) ũ before (b|p) e.g. cũplido, costũbre-->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="umbp">
...
<!--16) "õ - before (b|p) e.g. hōbres, Cōprar"-->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="ombp">
...
<!--17) "ō + dad|dades, bōdad, cōformidad", mode="ondad"-->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="ondad">
...
<!--18) "õ + dido|dida|didas|didos, cōcedido, cōcedida" mode="ondido"-->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="ondido">
...
<!--19) "ā + dad|des, trāquilidad, Hermādad" mode="andad"-->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="andad">
...
<!--20) "ā + ça|ças, ordenāça, templāça", mode="ança"-->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="ança">
...
<!--21) "ẽ  and ça|çan|ças, verguẽça, comiẽçan" mode="ença"-->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="ença">
...
<!--22) "đ at the beginning e.g. đspues, đllas (no further special characters like "ā|ẽ|õ|ũ")" mode="dewords"-->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="dewords">
...
<!--23) "ꝓ (q with tilde) inside a word, flaq̃za, riq̃zas (flaqueza, riquezas)" mode="wquew"-->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="wquew">
...
<!--24) "ꝓ (pro) at the beginning, ꝓhibir, ꝓcesso (prohibir, processo)" mode="prow-->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="prow">
...
<!--30) ⁊ (char204a) ==> y , mode="only-y"-->
    ...
    <xsl:template match="tei:foreign[@xml:lang = 'es']//text()[not(ancestor::tei:abbr)]" mode="only-y">
