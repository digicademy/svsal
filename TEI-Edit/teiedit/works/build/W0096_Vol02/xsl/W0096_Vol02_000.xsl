...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0096_Vol02-00-change-0003'"></xsl:param>
    <xsl:param name="editingDesc" as="xs:string" select="'Added foreign ES.'"/>
    ...
    <xsl:template match="t:i[not(ancestor::*[@xml:lang eq 'es'])][matches(.,' para | porque | y | dela | delas | dellas | en ')]">
