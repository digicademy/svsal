...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0096_Vol02-00-change0-0007'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Added references between milestones and summaries.'"/>
