...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2018-12-10'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0096_Vol02-00-change0-0006'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Added @xml:id, @unit to milestone and @n to div2.'"/>
    ...
    <xsl:template match="tei:milestone">
        <xsl:copy>
            ...
            <!--<xsl:message>Adding @xml:id to milestones</xsl:message>-->
    ...
    <xsl:template match="tei:div2">
        <xsl:copy>
            <xsl:copy-of select="@*"/>
            <!--<xsl:message>Adding @n to div2</xsl:message>-->
            <xsl:variable name="n" select="translate(@xml:id,'a|b|c|d|e','')"/>
