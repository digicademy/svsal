...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2019-09-09'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0001_Vol01_change_026'"/>
    ...
    <xsl:template match="tei:choice[(child::*[1]/tei:pb or child::*[1]/tei:cb or child::*[1]/tei:lb)
        ...
        <xsl:variable name="lb1" as="element(tei:lb)?" select="./child::*[1]/tei:lb"/><!--'Error: Resolve manually - more than one lb in choice/abbr'-->
