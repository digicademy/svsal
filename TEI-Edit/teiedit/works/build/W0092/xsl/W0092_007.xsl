...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2020-06-26'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0092_change_014'"/>
...
<!--    
    ...
    <xsl:function name="local:hyphens" as="xs:boolean">
        ...
        <xsl:value-of select="not($lb/ancestor::tei:note) and $lb/preceding-sibling::*[1]/self::tei:note and $lb/preceding-sibling::*[2]/self::tei:hi[matches((.//text())[last()],'-$') or $lb/preceding-sibling::*[1]/self::tei:milestone and $lb/preceding-sibling::*[2]/self::t:i[matches((.//text())[last()],'-$')]]"/>
    </xsl:function>
