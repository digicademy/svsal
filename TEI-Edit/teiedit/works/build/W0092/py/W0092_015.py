...
Adapted for W0029 from W0043_Vol02 28.08.24 CR
...
input = D:/SVN/trunk/teiedit/works/build/W0092/xml/W0092_015.xml
script = D:/SVN/trunk/teiedit/works/build/W0092/py/W0092_015.py
output = D:/SVN/trunk/teiedit/works/build/W0092/xml/W0092_016.xml

"""

# 1. read text as as string giving the exact location in SVN. Change the path according to the file location.

text = open("D:/Cindy/SVN/trunk/teiedit/works/build/W0092/xml/W0092_015.xml", encoding='utf-8').read()
...
cases = {
    ...
    '<listChange ordered="true">\n                ' : '<listChange ordered="true">\n                <change who="#CR #auto" when="2024-09-03" status="a_raw" xml:id="W0092_change_022" xml:lang="en">Automatically expanded abbreviations with lb/@break using python.</change>\n                ',
...
W0092_016 =open('D:/Cindy/SVN/trunk/teiedit/works/build/W0092/xml/W0092_016.xml', 'w', encoding='utf-8')
W0092_016.write(text_output)
W0092_016.close()
