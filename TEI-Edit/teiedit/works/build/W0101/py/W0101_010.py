...
text = open("D:/Cindy/SVN/trunk/teiedit/works/build/W0101/xml/W0101_010.xml", encoding='utf-8').read()
...
lineStart_final_um = '(<lb xml:id=\"[\d\w-]+\"/>)(\w+|\w+<g ref=\"#char00e6\">æ</g>\w+|\w+<g ref=\"#char0153\">œ</g>\w+|\w+<g ref=\"#chare0328\">ę</g>\w+|<g ref=\"#char017f\">ſ</g>+\w+|\w+<g ref=\"#charc0327\">ç</g>\w+)(<g ref=\"#charu0303\">ũ</g>)([\.,;:\?! \n])'
...
cases = {
    ...
    lineStart_final_um: '\g<1><choice><abbr>\g<2>\g<3></abbr><expan resp=\"#CRPY #auto\">\g<2>um</expan></choice>\g<4>',

    '<listChange ordered="true">\n                ' : '<listChange ordered="true">\n                <change who="#CR #auto" when="2025-11-27" status="a_raw" xml:id="W0101_change_011" xml:lang="en">Automatically expanded abbreviations with lb/@break using python.</change>\n                '
}
...
W0XXX_XXX =open('D:/Cindy/SVN/trunk/teiedit/works/build/W0101/xml/W0101_011.xml', 'w', encoding='utf-8')
