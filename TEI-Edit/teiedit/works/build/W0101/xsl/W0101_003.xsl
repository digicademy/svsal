...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0101'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2025-11-20'"/>
    ...
    <xsl:include href="W0101_003b.xsl"/>
...
<xsl:variable name="teiHeaderCopy" xml:space="preserve"><teiHeader>
        <fileDesc>
            <titleStmt>
                <title type="short" level="m">Dispvtationvm in secundam secundae D.Thomae. Tomus Vnus</title>
            ...
            <sourceDesc>
                <biblStruct>
                    <monogr>
                        ...
                        <extent xml:lang="de">[32] Bl., 1296 Sp., [25] Bl.</extent>
                        <extent xml:lang="en">[32] p., 1296 col., [25] p.</extent>
                        <extent xml:lang="es">[32] p., 1296 col., [25] p.</extent>
                    </monogr>
                </biblStruct>
                <msDesc>
                    <msIdentifier>
        ...
        <revisionDesc status="a_raw">
            <listChange ordered="true">
                ...
                <change who="#CR" when="2025-10-07" status="a_raw" xml:lang="en">Structural annotation and first round of unclear.</change>
