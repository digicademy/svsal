...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0037_Vol03_change_007'"></xsl:param>
...
<!-- 
    ...
    | How to add new cases:  |
     ...
     5) Write a template that matches only text in spanisch, which is not tagged as expansion yet and add the new mode:
          ...
          <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="ExampleNew">
...
<!-- 1) ẽ + "do" e.g. "pudiẽdo"-->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not(ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="endo">
...
<!-- 2) ã + "do" e.g. dudãdo -->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="ando">
...
<!-- 3) ẽ + "te|tes" e.g. "mortalmẽte", "gẽte"-->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="ente">
...
<!-- 4) ẽ + "de" e.g. "entiẽde"-->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="ende">
...
<!--5) "õ-on" at the end e.g. "Purificaciõ"-->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="cion">
...
<!-- 6) ẽ + "to" e.g. "mandamiẽto"-->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="ento">
...
<!--7) ẽ + "cia|cias" e.g. "differẽcia"-->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="encia">
...
<!--  8) ã + "ancia" e.g. "ignorãcia"-->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="ancia">
...
<!-- 9) ẽ + "er" e.g. "entẽder"-->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="ener">
...
<!-- 10) ẽ + "ar" e.g. "encomẽdar"-->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="enar">
...
<!-- 11) ã + "ar" e.g. "mãdar"-->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="anar">
...
<!-- 12) Words ending with (ẽ-en). e.g. puedẽ, quiẽ, deuẽ-->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="final-en">
...
<!-- 13) Words ending in (ā-an). e.g. haziā, siruā, podrā-->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="final-an">
...
<!-- 14) ũ + ar e.g. pregũtar, renũciar-->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="unar">
...
<!-- 15) ũ before (b|p) e.g. cũplido, costũbre-->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="umbp">
...
<!--16) "õ - before (b|p) e.g. hōbres, Cōprar"-->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="ombp">
...
<!--17) "ō + dad|dades, bōdad, cōformidad", mode="ondad"-->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="ondad">
...
<!--18) "õ + dido|dida|didas|didos, cōcedido, cōcedida" mode="ondido"-->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="ondido">
...
<!--19) "ā + dad|des, trāquilidad, Hermādad" mode="andad"-->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="andad">
...
<!--20) "ā + ça|ças, ordenāça, templāça", mode="ança"-->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="ança">
...
<!--21) "ẽ  and ça|çan|ças, verguẽça, comiẽçan" mode="ença"-->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="ença">
...
<!--22) "đ at the beginning e.g. đspues, đllas (no further special characters like "ā|ẽ|õ|ũ")" mode="dewords"-->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="dewords">
...
<!--23) "ꝓ (q with tilde) inside a word, flaq̃za, riq̃zas (flaqueza, riquezas)" mode="wquew"-->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="wquew">
...
<!--24) "ꝓ (pro) at the beginning, ꝓhibir, ꝓcesso (prohibir, processo)" mode="prow-->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="prow">
...
<!--30) ⁊ (char204a) ==> y , mode="only-y"-->
    ...
    <xsl:template match="text()[ancestor::tei:foreign and not (ancestor::tei:abbr or ancestor::*[@xml:lang = ('la','grc','gr','he','fr','pt','it')])]" mode="only-y">
