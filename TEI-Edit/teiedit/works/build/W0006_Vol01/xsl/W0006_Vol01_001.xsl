...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2020-07-07'"/>
        ...
        <xsl:copy>
            ...
            <xsl:attribute name="n">
                <xsl:variable name="n" as="xs:string">
                    <xsl:number value="count(preceding::tei:pb[ancestor::tei:back and not(ancestor::tei:note and @sameAs)]) + 639"/>
                </xsl:variable>
