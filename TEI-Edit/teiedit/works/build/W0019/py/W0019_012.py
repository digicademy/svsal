...
"""
In progress 01.08.24 abbreviations with <lb>
...
text = open("/home/marie-astrid/Documents/Salamanca/trunk/teiedit/works/build/W0019/xml/W0019_012.xml", encoding='utf-8').read()
...
cases = {
    ...
    '<listChange ordered="true">\n                ' : '<listChange ordered="true">\n                <change who="#CR #auto" when="2024-08-01" status="a_raw" xml:id="W0043_Vol02_change_017" xml:lang="en">Automatically expanded abbreviations with lb/@break using python.</change>\n                ',
...
W0043_Vol04_012 =open('/home/marie-astrid/Documents/Salamanca/trunk/teiedit/works/build/W0019/xml/W0019_013.xml', 'w', encoding='utf-8')
W0043_Vol04_012.write(text_output)
W0043_Vol04_012.close()
