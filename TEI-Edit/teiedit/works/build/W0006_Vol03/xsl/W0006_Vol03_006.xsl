...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0006_Vol03'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2020-10-02'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI-Tite to TEI-All.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0006_V0l03_change-014'"/>
    ...
    <xsl:include href="W0006_Vol03_006b.xsl"/>
...
<xsl:variable name="teiHeaderCopy" xml:space="preserve">
    <teiHeader>
        ...
        <revisionDesc status="a_raw">
            <listChange>
                <change who="#CR" when="2021-05-18" status="a_raw" xml:id="W0006_Vol03_change_022" xml:lang="en">Added (la) abbreviations depending on word structure with regex.</change>
                <change who="#CR" when="2020-10-16" status="a_raw" xml:id="W0006_Vol03_change_021" xml:lang="en">teiHeader update.</change>
