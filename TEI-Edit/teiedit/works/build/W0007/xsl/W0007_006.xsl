...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2018-08-23'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0014_change_0015'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Created @xml:id.'"/>
