...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0007_change_021'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Fix ordering of break attributes (@rendition and @break) and removed whitespace before non-breaking elements.'"/>
    ...
    <xsl:template match="tei:text//text()[following-sibling::node()[1][(self::tei:pb or self::tei:cb or self::tei:lb) 
