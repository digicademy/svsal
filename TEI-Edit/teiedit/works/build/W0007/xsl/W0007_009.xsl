...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2019-03-06'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0007_change_020'"/>
    ...
    <xsl:template match="/">
        ...
        <!-- a) solitary pb/cb/lb within choice are clues for duplications -->
        ...
        <!-- b) choice duplications (adjacent choice containing identical resolvings -->
        ...
        <!-- c) informing about empty choice children -->
