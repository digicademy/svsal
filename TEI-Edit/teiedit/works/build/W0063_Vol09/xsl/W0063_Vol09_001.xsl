...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0063_Vol09'"/>
    <xsl:param name="textId" as="xs:string" select="'Vol09'"/> <!-- "completeWork" (for the whole work) or "Vol_xx" (for volume xx) -->
    ...
    <xsl:param name="volumeNumber" as="xs:integer" select="09"/> <!-- number of the volume in a multi-volume work (must be "0" for single-volume works)  -->
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2024-04-23'"/>
    ...
    <xsl:include href="W0063_Vol09_001b.xsl"/>
...
<xsl:variable name="teiHeaderCopy" xml:space="preserve" xpath-default-namespace="no">
<teiHeader>
        <fileDesc>
            <titleStmt>
                <title type="short" level="m">Reportorio Mvy Copioso De El Texto Y Leyes de las siete Partidas</title>
                <title type="main" level="m">Reportorio Mvy Copioso De El Texto Y Leyes de las siete Partidas, Agora en esta vltima Impression, hecho por el Licenciado Gregorio Lopez de Touar, va por su Abecedario</title>
                <author>
                ...
                <author>
                    <persName ref="gnd:100541704 viaf:95295432" key="López de Tovar, Gregorio">
                        <forename>Gregorio</forename>
                        <surname>López de Tovar</surname>
                    </persName>
                </author>
            ...
            <editionStmt>
                <edition n="1.0.0" xml:id="W0063_Vol09-version1" xml:lang="en">
                    Complete digitized edition, <date type="digitizedEd" when="2024-04-24">2024-04-24</date>.
                </edition>
            </editionStmt>
            ...
            <publicationStmt xml:id="publicationStmt">
                ...
                <date type="digitizedEd" when="2024-04-24">2024-04-24</date>
                <idno>
                    <idno xml:id="urlid">https://id.salamanca.school/texts/W0063:vol9</idno>
                    <idno xml:id="urltei">https://id.salamanca.school/texts/W0063:vol9?format=tei</idno>
                    <idno xml:id="urlhtml">https://id.salamanca.school/texts/W0063:vol9?format=html</idno>
                    <idno xml:id="urlrdf">https://id.salamanca.school/texts/W0063:vol9?format=rdf</idno>
                    <idno xml:id="urliiif">https://id.salamanca.school/texts/W0063:vol9?format=iiif</idno>
                    <idno xml:id="urltxtorig">https://id.salamanca.school/texts/W0063:vol9?format=txt&amp;mode=orig</idno>
                </idno>
            </publicationStmt>
            ...
            <seriesStmt>
                ...
                <biblScope unit="volume" n="32.9">Volume 32.9</biblScope>
            </seriesStmt>
            <notesStmt>
                ...
                <biblStruct>
                    <monogr>
                        ...
                        <imprint>
                            ...
                            <date type="firstEd" when="1576">1576</date>
                            <publisher n="firstEd">
                        ...
                        <extent xml:lang="de">159 ungezählte Seiten</extent>
                        <extent xml:lang="en">159 ungezählte Seiten</extent>
                        <extent xml:lang="es">159 ungezählte Seiten</extent>
                    </monogr>
                </biblStruct>
                <msDesc>
                    <msIdentifier>
                        <repository ref="gnd:1231401982" xml:lang="de">Max-Planck-Institut für Rechtsgeschichte und Rechtstheorie.</repository>
                        <idno type="catlink" xml:lang="de">https://sunrise.lhlt.mpg.de/webOPACClient/start.do?KatKeySearch=646655</idno>
                    </msIdentifier>
                    <physDesc>
                        <typeDesc>
        ...
        <encodingDesc>
            ...
            <editorialDecl>
                ...
                <p xml:id="W0063_Vol09_RW">Reference works contain automatic hyphenation of marked and unmarked words in the pb, cb and lb elements.
        ...
        <revisionDesc status="g_enriched_approved">
            <listChange ordered="true">
                <change who="#CR #auto" when="2024-04-23" status="a_raw" xml:id="W0063_Vol09_change_005" xml:lang="en"><xsl:value-of select="$editingDesc"/></change>
                <change who="#CR #auto" when="2024-04-23" status="g_enriched_approved" xml:id="W0063_Vol09_change_004" xml:lang="en">teiHeader update for publication.</change>
                <change who="#CR" when="2024-04-18" status="a_raw" xml:id="W0063_Vol09_change_003" xml:lang="en">Structural annotation.</change>
                <change who="#CR" when="2023-11-23" status="a_raw" xml:id="W0063_Vol09_change_002" xml:lang="en">teiHeader: Author correction.</change>
                <change who="#CR" when="2022-03-03" status="a_raw" xml:id="W0063_Vol09_change_001" xml:lang="en">Set teiHeader.</change>
            </listChange>
        </revisionDesc>
    </teiHeader>
</xsl:variable>
