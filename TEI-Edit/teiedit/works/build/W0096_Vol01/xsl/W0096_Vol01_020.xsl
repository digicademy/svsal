...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2021-03-15'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0096_Vol01_change_027'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Generated @xml:id(s) after corrections.'"/>
