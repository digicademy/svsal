...
<!--Content and Index in nested lists-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2019-10-14'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0012_change_019'"></xsl:param>
    <xsl:param name="editingDesc" as="xs:string" select="'Added @type and nested lists in Index'"/>
...
<!-- Nested lists in index W0012-1274-->
    <xsl:template match="tei:list[@type='index']//tei:item"> <!--[ancestor::tei:div1[@xml:id eq 'INDEX_LOCORVM']]-->
        <xsl:copy>
            <xsl:choose>
    ...
    <xsl:template match="tei:list[@type='index']//tei:item//tei:p[1][not(ancestor::tei:argument)]"><!--[ancestor::tei:div1[@xml:id eq 'INDEX_LOCORVM']]-->
    ...
    <xsl:template match="tei:list[@type= 'index']//tei:item//tei:p[preceding-sibling::tei:p]"> <!--[ancestor::tei:div1[@xml:id eq 'INDEX_LOCORVM']]-->
