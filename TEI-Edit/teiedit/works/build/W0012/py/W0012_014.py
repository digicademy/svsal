...
text = open("D:/Cindy/SVN/trunk/teiedit/works/build/W0012/xml/W0012_014.xml", encoding='utf-8').read()
...
cases = {
    ...
    '<listChange ordered="true">\n                ' : '<listChange ordered="true">\n                <change who="#CR #auto" when="2026-08-20" status="a_raw" xml:id="W0012_change_032" xml:lang="en">Automatically expanded abbreviations with lb/@break using python.</change>\n                '
}
...
W0012_015 =open('D:/Cindy/SVN/trunk/teiedit/works/build/W0012/xml/W0012_015.xml', 'w', encoding='utf-8')
W0012_015.write(text_output)
W0012_015.close()
