...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0105'"/>
    ...
    <xsl:param name="volumeNumber" as="xs:integer" select="2"/> <!-- number of the volume in a multi-volume work (must be "0" for single-volume works)  -->
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0105_vol2-change-004'"/>
    ...
    <xsl:include href="W0105_Vol02_003b.xsl"/>
