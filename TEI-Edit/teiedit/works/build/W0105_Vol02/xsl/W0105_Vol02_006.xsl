...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editors" as="xs:string" select="'#MAH #DG #EE #auto'"/>
    <xsl:param name="editingDate" as="xs:string" select="'2026-02-11'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0105_Vol02_change_008'"/>
