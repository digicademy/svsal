...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0043_Vol04'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2022-12-14'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI-Tite to TEI-All.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0043_Vol04_change_009'"/>
    ...
    <xsl:include href="W0043_Vol04_003b.xsl"/>
  ...
  <teiHeader>
        ...
        <revisionDesc status="a_raw">
            <listChange ordered="true">
                <change who="{$editors}" when="2022-12-14" status="a_raw" xml:lang="en" xml:id="{$changeId}"><xsl:value-of select="$editingDesc"/></change>
