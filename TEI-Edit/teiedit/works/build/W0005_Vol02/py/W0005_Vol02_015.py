...
text = open("D:/Cindy/SVN/trunk/teiedit/works/build/W0005_Vol02/xml/W0005_Vol02_015.xml", encoding='utf-8').read()
...
cases = {
    ...
    '<listChange ordered="true">\n                ' : '<listChange ordered="true">\n                <change who="#CR #auto" when="2025-09-17" status="a_raw" xml:id="W0005_Vol02_change_024" xml:lang="en">Automatically expanded abbreviations with lb/@break using python.</change>\n                '
}
...
W0005_Vol02_016 =open('D:/Cindy/SVN/trunk/teiedit/works/build/W0005_Vol02/xml/W0005_Vol02_016.xml', 'w', encoding='utf-8')
W0005_Vol02_016.write(text_output)
W0005_Vol02_016.close()
