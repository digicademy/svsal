...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0005_Vol02'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2021-08-02'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI-Tite to TEI-All.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0005_Vol02_change_015'"/>
    ...
    <xsl:include href="W0005_Vol02_008b.xsl"/>
...
<xsl:variable name="teiHeaderCopy" xml:space="preserve">
    <teiHeader>
        <fileDesc>
            ...
            <titleStmt>
                <title type="short" level="m">Política Para Corregidores, Vol. 2</title>
                <title type="main" level="m">Politica para Corregidores y Señores de Vassallos, en Tiempo de Paz, y de Gverra : 
                    y para Perlados en los Espiritual, y para Iuezes Ecclesiasticos y Seglares, 
                    y de Sacas, Aduanas, y de Residencias, y sus Oficiales : y para Regidores, y Abogados : y 
                    del valor de los Corregimientos, y Gouiernos Realengos, y de las Ordenes</title>
            ...
            <sourceDesc>
                ...
                <msDesc>
                    <msIdentifier>
                        ...
                        <idno type="catlink" xml:lang="de">https://sunrise.rg.mpg.de/webOPACClient/start.do?Language=de&amp;KatKeySearch=552664</idno>
