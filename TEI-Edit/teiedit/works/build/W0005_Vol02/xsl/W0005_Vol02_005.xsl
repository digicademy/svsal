...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2021-06-21'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0005_Vol02_change_011'"></xsl:param>
    <xsl:param name="editingDesc" as="xs:string" select="'Added partially pb-cb/@sameAs in note(s).'"/>
