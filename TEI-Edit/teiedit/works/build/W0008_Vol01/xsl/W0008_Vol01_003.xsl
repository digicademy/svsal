...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0008_Vol01'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2022-02-01'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI-Tite to TEI-All.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0008_Vol01_change-010'"/>
    ...
    <xsl:include href="W0008_Vol01_003b.xsl"/>
    ...
    <teiHeader>
        <fileDesc>
            ...
            <titleStmt>
                ...
                <title type="main" level="m">De Ivstitia Tomvs Primvs, Complectens Tractatvm Primvm, Et Ex secundo disputationes. 251. vsq; ad vltimas voluntates inclusiue</title>
            ...
            <sourceDesc>
                <biblStruct>
                    <monogr>
                        ...
                        <imprint>
                            ...
                            <publisher n="firstEd">
                                <persName key="Masselin, Juan"><!--no authority data available-->
                ...
                <msDesc corresp="#facs:W0008-A-0077">
                    <msIdentifier>
                        ...
                        <!--<idno type="catlink" xml:lang="es">https://books.google.de/books?id=8jJjAAAAcAAJ&dq=De%20Ivstitia%20Tomvs%20Primvs%2C%20Complectens%20Tractatvm%20Primvm%2C%20Et%20Ex%20secundo%20disputationes%201593&hl=de&pg=PA125#v=onepage&q&f=false</idno>-->
                    </msIdentifier>
                    <physDesc>
                        <typeDesc>
                            <typeNote n="antiqua" xml:lang="en">Antiqua typeface</typeNote>
