...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0103'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2019-12-20'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI Tite to TEI P5.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0103_change_008'"/>
    ...
    <xsl:include href="W0103_004b.xsl"/>
            ...
            <sourceDesc>
                <biblStruct>
                    <monogr>
                        ...
                        <title type="main" level="m">Antonii Vaccae A capite Silicis, Iurisconsulti Imolensis Expositiones Locorvm Obscvriorvm Et Paratitvlorvm In Pandectas, Volumen Primum - Lvgdni, Apud Matthiam Bonhomme. M. D. LIIII. Cvm Privilegio Regis</title>
                        <imprint>
                            <pubPlace role="firstEd" ref="getty:7008772" key="place">Lyon</pubPlace>
                ...
                <msDesc>
                    <msIdentifier>
                        <repository ref="gnd:xxx cerl:xxx" xml:lang="de">Bayerische Staatsbibliothek</repository>
                        <idno type="catlink" xml:lang="ll">https://www.regensburger-katalog.de/s/ubrsbr/de/2/1035/BV009666089</idno>
                    </msIdentifier>
                    <physDesc>
                        <typeDesc>
