...
Adapted for W0074 from W0043_Vol02 28.08.24 CR
...
input = D:/SVN/trunk/teiedit/works/build/W0089/xml/W0089_011.xml
script = D:/SVN/trunk/teiedit/works/build/W0089/py/W0089_011.py
output = D:/SVN/trunk/teiedit/works/build/W0089/xml/W0089_012.xml

"""

# 1. read text as as string giving the exact location in SVN. Change the path according to the file location.

text = open("D:/Cindy/SVN/trunk/teiedit/works/build/W0074/xml/W0074_010.xml", encoding='utf-8').read()
...
final_t_tilde = '( )(\w+|\w+<g ref=\"#char00e6\">æ</g>\w+|\w+<g ref=\"#char0153\">œ</g>\w+|\w+<g ref=\"#chare0328\">ę</g>\w+|<g ref=\"#char017f\">ſ</g>+\w+|\w+<g ref=\"#charc0327\">ç</g>\w+)(<lb rendition=\"#\w+\" break=\"no\" |<lb break=\"no\" rendition=\"#\w+\" )(xml:id=\")([\d\w-]+\"/>)(\w+|\w+<g ref=\"#char00e6\">æ</g>\w+|\w+<g ref=\"#char0153\">œ</g>\w+|\w+<g ref=\"#chare0328\">ę</g>\w+|<g ref=\"#char017f\">ſ</g>+\w+|\w+<g ref=\"#charc0327\">ç</g>\w+)(<g ref="#chart0303">t̃</g>)([\.,;:\?! ])'
...
cases = {
    'P<g ref="#char0153">œ</g>nitentia eius<g ref="#charq0301">q́</g>;': 'P<g ref="#char0153">œ</g>nitentia <choice><abbr>eius<g ref="#charq0301">q́</g>;</abbr><expan resp="#MAH" cert="high" xml:id="ty3_zvl_zcc">eiusque</expan></choice>',
    ...
    final_t_tilde : '\g<1><choice><abbr>\g<2>\g<3>\g<4>\g<5>\g<6>\g<7></abbr><expan resp=\"#CRPY #auto\">\g<2>\g<3>sameAs=\"#\g<5>\g<6>tur</expan></choice>\g<8>',

    '<listChange ordered="true">\n                ' : '<listChange ordered="true">\n                <change who="#CR #MAH #auto" when="2024-09-22" status="a_raw" xml:id="W0074_change_012" xml:lang="en">Automatically expanded abbreviations with lb/@break using python.</change>\n                ',
...
W0074_011 =open('D:/Cindy/SVN/trunk/teiedit/works/build/W0074/xml/W0074_011.xml', 'w', encoding='utf-8')
W0074_011.write(text_output)
W0074_011.close()
