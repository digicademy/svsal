...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0043_Vol08_change_011'"></xsl:param>
    ...
    <xsl:template match="text()[matches(.,'[-=]\n?$') and following-sibling::node()[1][(self::tei:pb or self::tei:cb or self::tei:lb or self::tei:note or self::tei:milestone or self::tei:hi or self::t:i)]]" mode="breakLB">
        <xsl:choose>
