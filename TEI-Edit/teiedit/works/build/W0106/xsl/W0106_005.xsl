...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0106_change_xxx'"></xsl:param>
    ...
    <xsl:template match="tei:list[@type eq 'index']//tei:item[not(descendant::tei:list)]">
        <xsl:copy>
            <xsl:choose>
    ...
    <xsl:template match="tei:list[@type eq 'index']//tei:item//tei:p[1][not(ancestor::tei:argument)]">
    ...
    <xsl:template match="tei:list[@type eq 'index']//tei:item//tei:p[preceding-sibling::tei:p]"> 
