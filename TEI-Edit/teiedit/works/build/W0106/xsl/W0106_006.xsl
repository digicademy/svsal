...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0106'"/>
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2019-11-26'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI Tite to TEI All P5.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0106_change_012'"/>
    ...
    <xsl:include href="W0106_006b.xsl"/>
...
<xsl:variable name="teiHeaderCopy" xml:space="preserve">
    <teiHeader>
        ...
        <fileDesc>
            <titleStmt>
                <title type="short" level="m">Controversiarum Libri Tres</title>
                ...
                <author>
                    <persName ref="author:A0093 gnd:118626302 cerl:cnp01240906" key="Vázquez de Menchaca, Fernando">
                        <forename>Fernando</forename>
                        <surname>Vázquez de Menchaca</surname>
                    </persName>
                </author>
                ...
                <biblStruct>
                    <monogr>
                        ...
                        <imprint>
                            ...
                            <publisher n="firstEd">
                                <persName ref="gnd:118683527 cerl:cni00019583" key="Feyerabend, Sigismund">
                                    <forename>Feyerabend</forename>
                                    <surname>Sigismund</surname>
                                </persName>
                            </publisher>
                        </imprint>
                        <extent xml:lang="de">8 ungezählte Seiten, 291 Blätter, 32 ungezählte Seiten</extent>
                        <extent xml:lang="en">[8], 291, [32] l.</extent>
                        <extent xml:lang="es">[8], 291, [32] h.</extent>
                    </monogr>
                </biblStruct>
                <msDesc>
                    <msIdentifier>
        ...
        <revisionDesc status="a_raw">
            <listChange>
                ...
                <change who="#CR #auto" when="2019-11-21" status="a_raw" xml:id="W0106_change_009">Tagged label(s).</change>
