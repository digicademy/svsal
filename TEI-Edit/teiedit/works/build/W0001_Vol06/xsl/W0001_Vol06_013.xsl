...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="lang" as="xs:string" select="'la'"/> 
    
    <xsl:param name="editors" as="xs:string" select="'#DG #CR #auto'"/>
    <xsl:param name="editingDate" as="xs:string" select="'2019-09-12'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0001_Vol01_change_014'"/>
