...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0001_Vol06'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2019-09-02'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI Tite to TEI P5.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0001_Vol06_change_0007'"/>
    ...
    <xsl:include href="W0001_Vol06_005b.xsl"/>
    ...
    <teiHeader>
        <fileDesc>
            ...
            <titleStmt>
                ...
                <editor xml:id="IC">
                    <persName ref="gnd:1022577581" role="#technical">
            ...
            <sourceDesc>
                <biblStruct>
                    <monogr>
                        <author>
                            <persName ref="author:0007 gnd:133542521 cerl:cnp01376179" key="Avendaño, Diego de">
                                <forename>Diego</forename>
                                <nameLink>de</nameLink>
                                <surname>Avendaño</surname>
                            </persName>
