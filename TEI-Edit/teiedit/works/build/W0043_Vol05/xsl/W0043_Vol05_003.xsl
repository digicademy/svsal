...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0043_Vol05'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2023-03-08'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI-Tite to TEI-All.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0043_Vol05_change_009'"/>
    ...
    <xsl:include href="W0043_Vol05_003b.xsl"/>
  ...
  <teiHeader>
        ...
        <revisionDesc status="a_raw">
            <listChange ordered="true">
                <change who="#CR #auto" when="2023-03-08" status="a_raw" xml:id="W0043_Vol05_change_009" xml:lang="en"><xsl:value-of select="$editingDesc"/>.</change>
