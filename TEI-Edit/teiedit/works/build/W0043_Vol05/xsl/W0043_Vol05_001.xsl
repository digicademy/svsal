...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0043_Vol05_change_007'"/>
...
<!--Added @n, @type, @xml:id in div4 Liber 28 and 30 with most normalized @n(s)-->
    <xsl:template match="tei:div4[ancestor::tei:div1[@xml:id=('b28', 'b30')]]" mode="first-round">
        <xsl:copy>
            <xsl:copy-of select="@*"/>
...
<!--Added @n, @type, @xml:id in div4 Liber 31, 32, 33, 34-->
    <xsl:template match="tei:div4[ancestor::tei:div1[@xml:id=('b29','b31','b32','b33','b34','b35')]]" mode="first-round">
        <xsl:copy>
            <xsl:copy-of select="@*"/>
            <xsl:variable name="nDiv" select="count(preceding::tei:div4[not(@type)][ancestor::tei:div1 = current()/ancestor::tei:div1])+1"/>
            <xsl:choose>
