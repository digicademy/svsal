...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- Delete unnecessary ornaments.-->
    <xsl:template match="//tei:div2//tei:figure[@type='ornament'][ancestor::tei:head]"/>
    
    <!--Changed 2nd Head in div4 into argument-->
    <xsl:template match="tei:div4/tei:head[2]">
