...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2021-01-19'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0005_Vol01_change_008'"></xsl:param>
    <xsl:param name="editingDesc" as="xs:string" select="'Added missing pagination in front.'"/>
...
<!--Adding normalized pagination in front-matter.-->
