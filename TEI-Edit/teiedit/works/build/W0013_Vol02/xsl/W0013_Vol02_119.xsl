...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2023-11-22'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0013_Vol02_change_032'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Generated @xml:id, final corrections.'"/>
    <xsl:template match="tei:teiHeader/tei:revisionDesc/tei:listChange">
        <xsl:copy>
            ...
            <xsl:element name="change">
                ...
                <xsl:attribute name="xml:id" select="'W0013_Vol02_change_033'"/>
                <xsl:attribute name="xml:lang" select="'en'"/>
                <xsl:value-of select="'Corrected lb position W0013-02-0588-lb-0012 inside head.'"/>
            </xsl:element>
            <xsl:text>&#xa;                </xsl:text>
            <xsl:element name="change">
