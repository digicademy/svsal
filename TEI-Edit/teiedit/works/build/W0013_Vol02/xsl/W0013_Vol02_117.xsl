...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDesc" as="xs:string" select="'Tagged special characters, final corrections.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0013_Vol02_change_030'"/>
