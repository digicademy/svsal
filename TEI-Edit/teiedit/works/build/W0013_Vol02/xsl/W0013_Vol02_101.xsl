...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0013_Vol02_change_013'"></xsl:param>
    <xsl:param name="editingDesc" as="xs:string" select="'Produced new @xml:id and line numbering.'"/>
