...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2024-06-11'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0063_Vol02_change_004'"/>
    ...
    <xsl:template match="tei:p[@xml:id][ancestor::tei:div1[@type eq 'gloss']]">
        <xsl:copy>
            <xsl:copy-of select="@*"/>
