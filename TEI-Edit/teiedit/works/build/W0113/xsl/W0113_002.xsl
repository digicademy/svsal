...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0113'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0113_change_005'"/>
    ...
    <xsl:include href="W0113_002b.xsl"/>
  ...
  <teiHeader xmlns:t="http://www.tei-c.org/ns/tite/1.0" xmlns:tite="http://www.tei-c.org/ns/tite/1.0" xmlns:sal="http://salamanca.adwmainz.de">
        <fileDesc>
            <titleStmt>
                ...
                <author>
                    <persName ref="author:A0098 cerl:cnp01326236 viaf:7423594 gnd:1089545509" key="Villalón, Cristóbal de">
                ...
                <biblStruct>
                    <monogr>
                        ...
                        <imprint>
                            ...
                            <publisher n="firstEd">
                                <persName ref="cerl:cni00092530 viaf:313314828 gnd:1055667210" key="Fernandez de Córdoba, Francisco de">
                                    <forename>Francisco</forename>
                                    <surname>Fernandez d[e] Cordoua</surname>
                                </persName>
                            </publisher>
                        </imprint>
