...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0001_Vol03'"/>
    <xsl:param name="textId" as="xs:string" select="'Vol03'"/> <!-- "completeWork" (for the whole work) or "Vol_xx" (for volume xx) -->
    ...
    <xsl:param name="volumeNumber" as="xs:integer" select="03"/> <!-- number of the volume in a multi-volume work (must be "0" for single-volume works)  -->
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2019-06-24'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI Tite to TEI P5.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0001_Vol03_change_011'"/>
    ...
    <xsl:include href="W0001_Vol03_004b.xsl"/>
            ...
            <titleStmt>
                ...
                <editor xml:id="CR">
                    <persName ref="orcid:0000-0001-5095-1793">
                        <surname full="yes">Rico Carmona</surname>, <forename>Cindy</forename>
                    </persName>
                </editor>
                <editor xml:id="MT">
                    <persName ref="orcid:0000-0002-1488-6477">
                        <surname full="yes">Thönes</surname>, <forename>Martin</forename>
                    </persName>
                </editor>
                <editor xml:id="AW">
