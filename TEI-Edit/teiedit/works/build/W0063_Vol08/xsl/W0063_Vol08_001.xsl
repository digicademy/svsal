...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0063_Vol08'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2024-04-11'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI-Tite to TEI-All.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0063_Vol08_change__005'"/>
    ...
    <xsl:include href="W0063_Vol08_001b.xsl"/>
...
<teiHeader>
        <fileDesc>
            <titleStmt>
                <title type="short" level="m">Index seu repertorium materiarum</title>
                <title type="main" level="m">Index seu repertorium materiarum ac utriusque iuris decisionum quae in singulis septem partitarum glossis continentur</title>
                <author>
                ...
                <author>
                    <persName ref="gnd:119625024 viaf:68856893 cerl:cnp01116822" key="Boffaeus, Jacobus">
                        <forename>Jacobus</forename>
                        <surname>Boffaeus</surname>
                    </persName>
                </author>
            ...
            <editionStmt>
                <edition n="1.0.0" xml:id="W0063_Vol08-version1" xml:lang="en">
                    Complete digitized edition, <date type="digitizedEd" when="2024-04-11">2024-04-11</date>.
                </edition>
            </editionStmt>
            ...
            <publicationStmt xml:id="publicationStmt">
                ...
                <date type="digitizedEd" when="2024-04-11">2024-04-11</date>
                <idno>
                    <idno xml:id="urlid">https://id.salamanca.school/texts/W0063:vol8</idno>
                    <idno xml:id="urltei">https://id.salamanca.school/texts/W0063:vol8?format=tei</idno>
                    <idno xml:id="urlhtml">https://id.salamanca.school/texts/W0063:vol8?format=html</idno>
                    <idno xml:id="urlrdf">https://id.salamanca.school/texts/W0063:vol8?format=rdf</idno>
                    <idno xml:id="urliiif">https://id.salamanca.school/texts/W0063:vol8?format=iiif</idno>
                    <idno xml:id="urltxtorig">https://id.salamanca.school/texts/W0063:vol8?format=txt&amp;mode=orig</idno>
                </idno>
            </publicationStmt>
            ...
            <seriesStmt>
                ...
                <biblScope unit="volume" n="32.1">Volume 32.8</biblScope>
            </seriesStmt>
            <notesStmt>
            ...
            <sourceDesc>
                <biblStruct>
                    <monogr>
                        ...
                        <extent xml:lang="de">62 ungezählte Seiten</extent>
                        <extent xml:lang="en">62 ungezählte Seiten</extent>
                        <extent xml:lang="es">62 ungezählte Seiten</extent>
                    </monogr>
                </biblStruct>
                <msDesc>
                    <msIdentifier>
                        <repository ref="gnd:1231401982" xml:lang="de">Max-Planck-Institut für Rechtsgeschichte und Rechtstheorie.</repository>
                        <idno type="catlink" xml:lang="de">https://sunrise.lhlt.mpg.de/webOPACClient/start.do?KatKeySearch=646654</idno>
                    </msIdentifier>
                    <physDesc>
                        <typeDesc>
        ...
        <encodingDesc>
            ...
            <editorialDecl>
                ...
                <p xml:id="W0063_Vol08_RW">Reference works contain automatic hyphenation of marked and unmarked words in the pb, cb and lb elements.
        ...
        <revisionDesc status="g_enriched_approved">
            <listChange ordered="true">
                <change who="#CR #auto" when="2024-04-11" status="a_raw" xml:id="W0063_Vol08_change_005" xml:lang="en"><xsl:value-of select="$editingDesc"/></change>
                <change who="#CR #auto" when="2024-04-11" status="g_enriched_approved" xml:id="W0063_Vol08_change_004" xml:lang="en">teiHeader update for publication.</change>
                <change who="#CR" when="2024-04-10" status="a_raw" xml:id="W0063_Vol08_change_003" xml:lang="en">Structural annotation.</change>
                <change who="#CR" when="2023-11-23" status="a_raw" xml:id="W0063_Vol08_change_002" xml:lang="en">teiHeader: Author correction.</change>
                <change who="#CR" when="2022-03-03" status="a_raw" xml:id="W0063_Vol08_change_001" xml:lang="en">Set teiHeader.</change>
            </listChange>
        </revisionDesc>
    </teiHeader>
</xsl:variable>
