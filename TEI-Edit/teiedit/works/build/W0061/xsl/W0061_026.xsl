...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0061_change_033'"></xsl:param>
    <xsl:param name="editingDesc" as="xs:string" select="'Added @type note-anchor and @n to ref-elements. '"/>
