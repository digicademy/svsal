<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2018-12-18'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0061_change_015'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Delete @role=data in cell and row'"/>
