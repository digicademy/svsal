...
text = open("D:/Cindy/SVN/trunk/teiedit/works/build/W0053/xml/W0053_011.xml", encoding='utf-8').read()
...
cases = {
    ...
    '<listChange ordered="true">\n                ' : '<listChange ordered="true">\n                <change who="#CR #auto" when="2025-09-02" status="a_raw" xml:id="W0053_change_017" xml:lang="en">Automatically expanded abbreviations with lb/@break using python.</change>\n                '
}
...
W0053_012 =open('D:/Cindy/SVN/trunk/teiedit/works/build/W0053/xml/W0053_012.xml', 'w', encoding='utf-8')
W0053_012.write(text_output)
W0053_012.close()
