...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0003_change_023'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Structural changes: div/@type=commented to div/@type=source, tei:cit to tei:bibl'"/>
    ...
    <xsl:template match="tei:div[@type eq 'commented']">
        <xsl:copy>
            <xsl:copy-of select="@*"/>
