...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0003_change_0006'"/>
    ...
    <xsl:template match="/">
        ...
        <xsl:message select="'Added line numbers to tei:lb/@n.'"/>
        <xsl:message select="'Serializing final output...'"/>
    </xsl:template>
