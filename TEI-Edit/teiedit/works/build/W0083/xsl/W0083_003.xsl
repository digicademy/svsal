...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0083'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2020-10-15'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI-Tite to TEI-All.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0083_change_005'"/>
    ...
    <xsl:include href="W0083_003b.xsl"/>
  ...
  <teiHeader xmlns:t="http://www.tei-c.org/ns/tite/1.0" xmlns:tite="http://www.tei-c.org/ns/tite/1.0" xmlns:sal="http://salamanca.adwmainz.de">
        <fileDesc>
            <titleStmt>
                ...
                <author>
                    <persName ref="author:A0069 cerl:cnp02179962 viaf:36035482 gnd:/119097052" key="Pedraza, Juan de">
                ...
                <biblStruct>
                    <monogr>
                        ...
                        <imprint>
                            ...
                            <publisher n="firstEd">
                                <persName ref="cerl:cni00045649 viaf:14828413" key="Canto, Francisco del">
        ...
        <revisionDesc status="a_raw">
            <listChange ordered="true">
                <change who="#CR #auto" when="2020-10-21" status="a_raw" xml:lang="en" xml:id="W0083_change_012">Added (es) abbreviations depending on word endings with regex.</change>
