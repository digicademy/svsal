...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2021-05-03'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0083_change_019'"/>
    ...
    <xsl:template match="/">
        ...
        <xsl:choose>
            ...
            <xsl:when test="//tei:choice[./*[1]//(tei:pb|tei:cb|tei:lb) and ./*[2][.//tei:g[not(matches(.,'[ſçñ]+'))] and not(.//(tei:pb|tei:cb|tei:lb))]]">
