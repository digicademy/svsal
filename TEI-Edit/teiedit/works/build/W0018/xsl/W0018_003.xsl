...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0018'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2020-12-23'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI-Tite to TEI-All.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0018_change_006'"/>
    ...
    <xsl:include href="W0018_003b.xsl"/>
...
<xsl:variable name="teiHeaderCopy" xml:space="preserve">
  <teiHeader xmlns:t="http://www.tei-c.org/ns/tite/1.0" xmlns:tite="http://www.tei-c.org/ns/tite/1.0" xmlns:sal="http://salamanca.adwmainz.de">
        <fileDesc>
            <titleStmt>
                <title type="short" level="m">Tractado de los préstamos que passan entre mercaderes y tractantes y, por consiguiente, de los logros, cambios, compra adelantadas y ventas al fiado.</title>
                <title type="main" level="m">Tractado en que a la clara ſe ponen y determinan las materias delos p[r]estamos que ſe vſan entre los que tractan y negocian: y delos logros [y] co[mpr]as delantadas y ventas al fiado. [e]tc. Compueſto por fray Luys de Alcala / de la orden del bienauentutado padre ſant Francisco de obſeruancia: dela prouincia de Caſtilla. Uiſto y examinado por el consejo Real deſtos Reynos. </title>
                <author>
                    <persName ref="author:A0003 cerl:cnp00099755 viaf:169431628 gnd:100007112" key="Alcalá, Luis de">
                ...
                <biblStruct>
                    <monogr>
                        ...
                        <imprint>
                            ...
                            <publisher n="firstEd">
                                <persName ref="cerl:cni00007995 viaf:66518925 gnd:1077518854" key="Ayala, Juan de">
