...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0018_change_004'"></xsl:param>
    <xsl:param name="editingDesc" as="xs:string" select="'Added @type to list, @rend to note, @unit and @xml:ids to milestone.'"/>
    ...
    <!--Added @unit and @xml:ids to milestone.-->
