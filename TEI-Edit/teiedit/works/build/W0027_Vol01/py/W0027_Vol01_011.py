...
text = open("D:/SVN/trunk/teiedit/works/build/W0027_Vol01/xml/W0027_Vol01_011.xml", encoding='utf-8').read()
...
cases = {
    ...
    '<listChange ordered="true">\n                ' : '<listChange ordered="true">\n                <change who="#CR #auto" when="2026-06-24" status="a_raw" xml:id="W0027_Vol01_change_013" xml:lang="en">Automatically expanded abbreviations with lb/@break using python.</change>\n                '
}
...
W0XXX_XXX =open('D:/SVN/trunk/teiedit/works/build/W0027_Vol01/xml/W0027_Vol01_012.xml', 'w', encoding='utf-8')
W0XXX_XXX.write(text_output)
W0XXX_XXX.close()
