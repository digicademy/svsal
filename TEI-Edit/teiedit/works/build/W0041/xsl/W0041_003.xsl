...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0041'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2020-12-29'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI-Tite to TEI-All.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0041_change_006'"/>
    ...
    <xsl:include href="W0041_003b.xsl"/>
  ...
  <teiHeader xmlns:t="http://www.tei-c.org/ns/tite/1.0" xmlns:tite="http://www.tei-c.org/ns/tite/1.0" xmlns:sal="http://salamanca.adwmainz.de">
        <fileDesc>
            <titleStmt>
                ...
                <author>
                    <persName ref="author:A0027 cerl:61572063 viaf:61572063 gnd:182971066" key="Bernal Díaz de Lugo, Juan">
                        <forename>Juan</forename>
                        <surname>Bernal Díaz de Lugo</surname>
                    </persName>
                </author>
