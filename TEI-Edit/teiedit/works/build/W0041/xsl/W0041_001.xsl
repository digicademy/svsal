...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2020-12-DD'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0041_change_004'"></xsl:param>
    ...
    <xsl:template match="tei:div1[@type eq 'book']//tei:div2[not(@type)]">
     <xsl:copy>
         <xsl:variable name="chapNum" select="count(preceding-sibling::*/self::tei:div2[ancestor::tei:div1[@type eq 'book']])+1"/>
