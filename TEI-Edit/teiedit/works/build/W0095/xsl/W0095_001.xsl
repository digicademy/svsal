...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0095'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2020-01-13'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI Tite to TEI P5.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0095_change_004'"/>
    ...
    <xsl:include href="W0095_001b.xsl"/>
...
<xsl:variable name="teiHeaderCopy" xml:space="preserve">
  <teiHeader>
        <fileDesc>
            <titleStmt>
                <title type="short" level="m">Apologia Ioannis Genesij Sepuluedae pro libro de iustis belli causis</title>
            ...
            <sourceDesc>
                <biblStruct>
                    <monogr>
                        ...
                        <title type="main" level="m">Apologia Ioannis Genesij Sepuluedae pro libro de iustis belli causis : ad amplissimum &amp; doctissimum praesulem D. Antonium Ramirum episcopum Segouiensem</title>
                        <imprint>
                            <pubPlace role="firstEd" ref="getty:7000874" key="Rome">Rome</pubPlace>
                            ...
                            <publisher n="firstEd">
                                ...
                                <!--<orgName ref="gnd:1090712588 viaf:256475822">Valerium Doricum &amp; Ludouicum fratres Brixienses</orgName>-->
                            </publisher>
                        </imprint>
                        <extent xml:lang="de">[48] Bl.</extent>
                        <extent xml:lang="en">[48] l.</extent>
                        <extent xml:lang="es">[48] h.</extent>
                    </monogr>
                </biblStruct>
                <msDesc>
                    <msIdentifier>
