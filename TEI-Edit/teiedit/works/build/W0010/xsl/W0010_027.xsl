...
<xsl:variable name="teiHeader" xml:space="preserve">
    <teiHeader>
        ...
        <revisionDesc status="g_enriched_approved">
            <listChange>
                <change who="#CR #auto" when="2019-10-24" status="g_enriched_approved" xml:lang="en" xml:id="W0010_change_049">teiHeader update. Rearranged editor(s) sequece and @role #additional.</change>
                <change who="#DG #CR #auto" when="2019-08-07" status="g_enriched_approved" xml:id="W0010_change_048" xml:lang="en">Revised teiHeader, update @role in editor.</change>
