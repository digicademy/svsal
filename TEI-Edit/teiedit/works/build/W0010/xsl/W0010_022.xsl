...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2019-05-10'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0010_change_043'"/>
    ...
    <!-- template is applied only if second choice child contains nothing but text (important: this omits choice where breaks within the second child already have been tagged manually) -->
