...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0010'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2019-01-17'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI Tite to TEI P5, integrating text (Tite) and teiHeader.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0010-change-0016'"/>
    ...
    <xsl:include href="W0010_002b.xsl"/>
...
<!-- http://bdh.bne.es/bnesearch/detalle/bdh0000134097 -->
            </sourceDesc>
        </fileDesc>
