...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0008_Vol06'"/>
    <xsl:param name="textId" as="xs:string" select="'Vol06'"/> <!-- "completeWork" (for the whole work) or "Vol_xx" (for volume xx) -->
    ...
    <xsl:param name="volumeNumber" as="xs:integer" select="06"/> <!-- number of the volume in a multi-volume work (must be "0" for single-volume works)  -->
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editors" as="xs:string" select="'#DG #CR #PS #auto'"/>
    <xsl:param name="editingDate" as="xs:string" select="'2024-01-18'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI-Tite to TEI-All.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0008_Vol07_change_012'"/>
    ...
    <xsl:include href="W0008_Vol06_004b.xsl"/>
