...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tei:lb">
        <xsl:copy>
            ...
            <xsl:choose>
<!-- #PS(20.04.2022):added attribute @type 'nb' to delete hyphen -->
...
<!-- #PS (20.04.2022): this template deletes hyphems before note/lb @type 'nb'  -->
<xsl:template match="//node()[matches(.,'-$') and following-sibling::node()[2]/self::tei:lb[@type eq 'nb']]">
