...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2024-01-17'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0008_Vol06_change_009'"></xsl:param>
...
<!-- div/@n -->
<xsl:template match="tei:body//tei:div2[@type='disputation']">
         <xsl:copy>
<xsl:copy-of select="@*"/>
             <xsl:variable name="div2" select="count(preceding::tei:div2[@type='disputation'])+1"/>
