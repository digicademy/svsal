...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editors" as="xs:string" select="'#CR #PS #auto'"/>
    <xsl:param name="editingDate" as="xs:string" select="'2025-09-17'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0008_Vol06_change_011'"></xsl:param>
