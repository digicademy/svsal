...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0051_Vol01_change_11'"/>
    <xsl:param name="editingDesc" as="xs:string" select="concat('Tag unmarked breaks (', $lang, ') in main.')"/>
