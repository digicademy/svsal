...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0006_Vol02'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2020-09-09'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI-Tite to TEI-All.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0006_Vol02_change-014'"/>
    ...
    <xsl:include href="W0006_Vol02_005b.xsl"/>
...
<xsl:variable name="teiHeaderCopy" xml:space="preserve">
    <teiHeader>
        ...
        <revisionDesc status="a_raw">
            <listChange>
                <change who="#CR" when="2020-10-16" status="a_raw" xml:id="W0006_Vol02_change_021" xml:lang="en">teiHeader update.</change>
