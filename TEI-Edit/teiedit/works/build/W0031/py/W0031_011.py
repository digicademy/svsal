...
text = open("/home/marie-astrid/Documents/Salamanca/trunk/teiedit/works/build/W0031/xml/W0031_010.xml", encoding='utf-8').read()
...
cases = {
    ...
    '<listChange ordered="true">\n                ' : '<listChange ordered="true">\n                <change who="#CR #MAH #auto" when="2025-04-17" status="f_enriched" xml:id="W0031_0010" xml:lang="en">Automatically expanded abbreviations with lb/@break using python.</change>\n                ',
...
W0031_011 =open("/home/marie-astrid/Documents/Salamanca/trunk/teiedit/works/build/W0031/xml/W0031_011.xml", 'w', encoding='utf-8')
W0031_011.write(text_output)
W0031_011.close()
