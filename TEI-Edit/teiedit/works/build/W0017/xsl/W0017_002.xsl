...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="workId" as="xs:string" select="'W0017'"/>
...
<!--    <xsl:param name="analyzeTextEnabled" as="xs:boolean" select="true()"/> <!-\- this doens't need to be modified -\->-->
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2018-09-05'"/>
    <xsl:param name="editingDesc" as="xs:string" select="'Transformation from TEI Tite to TEI P5.'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0017-00-change-0003'"/>
    ...
    <xsl:include href="W0017_002b.xsl"/>
  ...
  <teiHeader xml:lang="de">
        <fileDesc>
            ...
            <titleStmt>
                ...
                <author>
                    <persName ref="author:A0002 gnd:104592251X cerl:cnp02094209" key="Albornoz, Bartolomé de" full="yes">
                        <forename full="yes">Bartolomé</forename>
                        <nameLink>de</nameLink>
                        <surname full="yes">Albornoz</surname>
                    </persName>
                </author>
                <editor xml:id="CB">
                ...
                <biblStruct>
                    <monogr>
                        ...
                        <imprint>
                            ...
                            <publisher n="firstEd">
                                <persName ref="gnd:1037649370" key="Huete, Pedro de" full="yes">
                                    <forename full="yes">Pedro</forename>
                                    <nameLink>de</nameLink>
                                    <surname full="yes">Huete</surname>
                                </persName>
                            </publisher>
                        </imprint>
                        <extent>[5], 176 Bl. ; 2°</extent>
                    </monogr>
                </biblStruct>
                <msDesc type="main">
                    <msIdentifier>
                        ...
                        <idno>
                            ...
                            <idno type="catlink" xml:lang="en">http://stabikat.de/DB=1/LNG=DU/SID=13ba198e-2/TTL=1/XMLPRS=N/LNG=EN/PPN?PPN=59416821X</idno>
                        </idno>
                    </msIdentifier>
                    <physDesc>
                        <typeDesc>
        ...
        <profileDesc>
           <langUsage>
              ...
              <language ident="es" n="administrative" xml:lang="la">Latin</language>
           </langUsage>
        </profileDesc>
        <encodingDesc>
