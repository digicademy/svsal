...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="changeId" as="xs:string" select="'W0111_change_016'"></xsl:param>
    <xsl:param name="editingDesc" as="xs:string" select="'Changed milestone[not(@n)]/unit to unit=other.'"/>
    ...
    <xsl:template match="tei:milestone[not(@n)]">
        <xsl:copy>
