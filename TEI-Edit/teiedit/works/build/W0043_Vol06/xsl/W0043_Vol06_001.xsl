...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="editingDate" as="xs:string" select="'2023-02-21'"/>
    <xsl:param name="changeId" as="xs:string" select="'W0043_Vol06_change_007'"/>
...
<!--Added @n, @type, @xml:id in div4 Liber 36, b37-->
    <xsl:template match="tei:div4[ancestor::tei:div1[@xml:id=('b36','b37','b39','b40','b41')]]" mode="first-round">
        <xsl:copy>
            <xsl:copy-of select="@*"/>
...
<!--Added @n, @type, @xml:id in div4 Liber 38 with most normalized @n(s)-->
    <xsl:template match="tei:div4[ancestor::tei:div1[@xml:id=('b38')]]" mode="first-round">
        <xsl:copy>
            <xsl:copy-of select="@*"/>
            <xsl:variable name="nDiv" select="count(preceding::tei:div4[not(@type)][ancestor::tei:div1 = current()/ancestor::tei:div1])+1"/>
            <xsl:choose>
