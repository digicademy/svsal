...
<<<<<<< Updated upstream
	...
	<xsl:variable name="guidelines"
		select="document('http://files.salamanca.school/works-general.xml')"/>
	<xsl:variable name="specialchars"
		select="document('http://files.salamanca.school/specialchars.xml')"/>
    ...
    <xsl:template match="/">
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format"
            ...
            <fo:layout-master-set>
                ...
                <fo:simple-page-master master-name="start" page-height="29.7cm" page-width="21cm"
                    margin-top="1.77cm" margin-bottom="1.77cm" margin-left="1.5cm"
                    margin-right="1.5cm">
                    <fo:region-body margin-top="1.52cm" margin-bottom="1.27cm" margin-left="1.5cm"
                        margin-right="1.5cm"/>
                ...
                <fo:simple-page-master master-name="pics" page-height="29.7cm" page-width="21cm"
                    margin-top="1cm" margin-bottom="1cm" margin-left="1cm" margin-right="1cm">
                    <fo:region-body margin-top="0cm" margin-bottom="0cm" margin-left="0cm"
                        margin-right="0cm"/>
                </fo:simple-page-master>
                <!-- Odd pages layout-->
                <fo:simple-page-master master-name="chapsOdd" page-height="29.7cm" page-width="21cm"
                    margin-top="1.77cm" margin-bottom="1.77cm" margin-left="1.5cm"
                    margin-right="1.5cm">
                    <fo:region-body margin-top="1.52cm" margin-bottom="1.27cm" margin-left="1.5cm"
                        margin-right="1.5cm"/>
                ...
                <fo:simple-page-master master-name="chapsEven" page-height="29.7cm"
                    page-width="21cm" margin-top="1.77cm" margin-bottom="1.77cm" margin-left="1.5cm"
                    margin-right="1.5cm">
                    <fo:region-body margin-top="1.52cm" margin-bottom="1.27cm" margin-left="1.5cm"
                        margin-right="1.5cm"/>
                ...
                <fo:page-sequence-master master-name="chaps">
                    <fo:repeatable-page-master-alternatives>
                        ...
                        <fo:conditional-page-master-reference master-reference="chapsOdd"
                            odd-or-even="odd"/>
                        <!--   <fo:conditional-page-master-reference master-reference="chapsEven" page-position="any"/>-->
                        <fo:conditional-page-master-reference master-reference="chapsEven"
                            odd-or-even="even"/>
                    </fo:repeatable-page-master-alternatives>
                </fo:page-sequence-master>
>>>>>>> Stashed changes
...
=======
                ...
                <fo:flow flow-name="xsl-region-body">
                    <fo:block text-align="center">
                        <fo:external-graphic content-width="19cm" content-height="27.7cm">
                            <xsl:attribute name="src">
                                <xsl:value-of
                                    select="$guidelines/key('title_image', $work_id)/tei:image/text()"
                                />
                            </xsl:attribute>
                        </fo:external-graphic>
                    </fo:block>
            ...
            <fo:page-sequence master-reference="start">
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <fo:block text-align="center" font-size="20pt" font-weight="normal"
                        space-before="10mm" space-after="10mm">
                        ...
                        <fo:block>
                            <fo:table>
                                ...
                                <fo:table-body>
                                    ...
                                    <xsl:apply-templates select="//tei:text//tei:note"
                                        mode="make-endnotes"/>
                                </fo:table-body>
                            </fo:table>
                        </fo:block>
...
=======
    ...
    <xsl:template match="tei:sourceDesc">
        ...
        <fo:block text-align="center" font-size="16pt" space-before="12mm">Electronic publication,
            ...
            /></fo:block>
        <fo:block text-align="center" font-size="15pt">Online: <xsl:apply-templates
                select="//tei:publicationStmt//tei:idno[@xml:id = 'urlid']"/></fo:block>
    </xsl:template>
...
-->
    ...
    <xsl:template match="tei:head">
        <fo:block text-align="justify" font-size="16pt" font-weight="bold" space-before="20pt"
            text-indent="0em" keep-with-next="always">
            <xsl:apply-templates/>
        </fo:block>
    </xsl:template>
    <xsl:template match="tei:item">
...
=======
   ...
   -->
                        ...
                        <xsl:variable name="number" select="@n"/>
                        <fo:block id="{$id_notes}" space-before="5mm" space-after="5mm"
                            font-size="10pt" text-align="justify">
                            <fo:basic-link font-weight="bold" color="#0a0c75"
                                internal-destination="{$link_anchor}">
                                <xsl:value-of
